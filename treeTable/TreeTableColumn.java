/*
 * @(#)TreeTreeTableColumn.java	1.57 03/01/23
 *
...
/**
 *  A <code>TreeTreeTableColumn</code> represents all the attributes of a column in a
 *  <code>TreeTable</code>, such as width, resizibility, minimum and maximum width.
 *  In addition, the <code>TreeTreeTableColumn</code> provides slots for a renderer and 
 *  an editor that can be used to display and edit the values in this column. 
 *  <p>
 *  It is also possible to specify renderers and editors on a per type basis
 *  rather than a per column basis - see the 
 *  <code>setDefaultRenderer</code> method in the <code>TreeTable</code> class.
 *  This default mechanism is only used when the renderer (or
 *  editor) in the <code>TreeTreeTableColumn</code> is <code>null</code>.
 * <p>
 *  The <code>TreeTreeTableColumn</code> stores the link between the columns in the
 *  <code>TreeTable</code> and the columns in the <code>TableModel</code>.
 ...
 *    <code>TreeTableColumnModel</code>s are unique, therefore we would 
 *    recommend that the same <code>TreeTableColumn</code> instance
 *    not be added more than once to a <code>TreeTableColumnModel</code>.
 *    To show <code>TreeTableColumn</code>s with the same column of
 ...
 * @author Alan Chung
 * @author Philip Milne
 * @see javax.swing.table.TreeTableColumnModel
 *
 * @see javax.swing.table.DefaultTreeTableColumnModel
 * @see javax.swing.table.TreeTableHeader#getDefaultRenderer()
 * @see TreeTable#getDefaultRenderer(Class)
 * @see TreeTable#getDefaultEditor(Class)
 * @see TreeTable#getCellRenderer(int, int)
 * @see TreeTable#getCellEditor(int, int)
 */
public class TreeTableColumn extends Object implements Serializable {

    static final long serialVersionUID = 8050821234566521228L;
...
//
     ...
     * this <code>TreeTableColumn</code>. As columns are moved around in the
     ...
     *  the <code>TreeTable</code>; identifiers may be set in the
     *  <code>TreeTableColumn</code> as as an
     ...
     *  <code>DefaultTreeTableColumnModel</code>.
     */
    ...
    protected TreeTableCellRenderer headerRenderer;
    ...
    protected TreeTableCellEditor cellEditor;

    /** If true, the user is allowed to resize the column; the default is true. */
    protected boolean isResizable;

    /** the column icon, null if there isn't one. */
    private Icon icon;
...
//
     ...
     *  @see #TreeTableColumn(int, int, TreeTableCellRenderer, TreeTableCellEditor)
     */
     ...
     *  @see #TreeTableColumn(int, int, TreeTableCellRenderer, TreeTableCellEditor)
     */
    public TreeTableColumn(int modelIndex, int width) {
        this(modelIndex, width, null, null);
    }

    /**
     *  Creates and initializes an instance of 
     *  <code>TreeTableColumn</code> with <code>modelIndex</code>.
     *  All <code>TreeTableColumn</code> constructors delegate to this one.
     ...
     *  <code>TreeTable</code> class are used to 
     ...
     *  the <code>getCellRenderer</code> methods in the <code>TreeTable</code>. 
     *  <p>
     *
     * @see TreeTable#getDefaultRenderer(Class)
     * @see TreeTable#getDefaultEditor(Class)
     ...
     */
    public TreeTableColumn(int modelIndex, int width,
            TreeTableCellRenderer cellRenderer,
            TreeTableCellEditor cellEditor) {
        super();
...
//
     ...
     * <code>TreeTableColumn</code>. As the <code>TreeTableColumn</code>
    ...
    /**
     * Sets the <code>TreeTableColumn</code>'s identifier to
     * <code>anIdentifier</code>. <p>
     * Note: identifiers are not used by the <code>TreeTable</code>,
     * they are purely a
     ...
     *  Note identifiers are not used by <code>TreeTable</code>,
     ...
     * <code>TreeTableColumn</code> is created, the default <code>headerValue</code>
     * is <code>null</code>.
    ...
    //
    /**
     * Sets the <code>TreeTableCellRenderer</code> used to draw the 
     * <code>TreeTableColumn</code>'s header to <code>headerRenderer</code>. 
     *
     ...
     */
    public void setHeaderRenderer(TreeTableCellRenderer headerRenderer) {
        TreeTableCellRenderer old = this.headerRenderer;
        this.headerRenderer = headerRenderer;
        firePropertyChange("headerRenderer", old, headerRenderer);
    }

    /**
     * Returns the <code>TreeTableCellRenderer</code> used to draw the header of the
     * <code>TreeTableColumn</code>. When the <code>headerRenderer</code> is
     * <code>null</code>, the <code>TreeTableHeader</code>
     ...
     * @see	javax.swing.table.TreeTableHeader#getDefaultRenderer()
     */
    public TreeTableCellRenderer getHeaderRenderer() {
        return headerRenderer;
    }

    /**
     * Sets the <code>TreeTableCellRenderer</code> used by <code>TreeTable</code>
     ...
     */
    public void setCellRenderer(TreeTableCellRenderer cellRenderer) {
        TreeTableCellRenderer old = this.cellRenderer;
        this.cellRenderer = cellRenderer;
        firePropertyChange("cellRenderer", old, cellRenderer);
    }

    /**
     * Returns the <code>TreeTableCellRenderer</code> used by the
     * <code>TreeTable</code> to draw
     ...
     * the <code>TreeTable</code> uses a default renderer based on the 
     ...
     * @see	#setCellRenderer
     * @see	TreeTable#setDefaultRenderer
     */
     ...
     */
    public void setCellEditor(TreeTableCellEditor cellEditor) {
        TreeTableCellEditor old = this.cellEditor;
        this.cellEditor = cellEditor;
        firePropertyChange("cellEditor", old, cellEditor);
    }

    /**
     * Returns the <code>TreeTableCellEditor</code> used by the
     * <code>TreeTable</code> to edit values for this column.  When the 
     * <code>cellEditor</code> is <code>null</code>, the <code>TreeTable</code>
     ...
     * @see	#setCellEditor
     * @see	TreeTable#setDefaultEditor
     */
     ...
     * <code>TreeTable</code>, use <code>setPreferredWidth</code> instead.
     * Like a layout manager in the 
     * AWT, the <code>TreeTable</code> adjusts a column's width automatically
     * whenever the 
     ...
     * @see     TreeTable#sizeColumnsToFit(int)
     * @beaninfo
     *  bound: true
    ...
    /**
     * Returns the width of the <code>TreeTableColumn</code>. The default width is
     * 75.
     *
     ...
     * it is adjusted to the appropriate limiting value. 
     * <p>
     * For details on how the widths of columns in the <code>TreeTable</code> 
     * (and <code>TreeTableHeader</code>) are calculated from the
     * <code>preferredWidth</code>, 
     * see the <code>sizeColumnsToFit</code> method in <code>TreeTable</code>. 
     *
    ...
    /**
     * Returns the preferred width of the <code>TreeTableColumn</code>. 
    ...
    /**
     * Sets the <code>TreeTableColumn</code>'s minimum width to
    ...
    /**
     * Returns the minimum width for the <code>TreeTableColumn</code>. The
     * <code>TreeTableColumn</code>'s width can't be made less than this either
    ...
    /**
     * Sets the <code>TreeTableColumn</code>'s maximum width to
    ...
    /**
     * Returns the maximum width for the <code>TreeTableColumn</code>. The
     * <code>TreeTableColumn</code>'s width can't be made larger than this
    ...
    /**
     * Resizes the <code>TreeTableColumn</code> to fit the width of its header cell.
     ...
     * The transient "width" property of this TreeTableColumn is also set to the 
    ...
    public void sizeWidthToFit() {
        ...
        Component c = headerRenderer.getTreeTableCellRendererComponent(null,
                getHeaderValue(),
                false, false, false,
                0, 0, false);
...
//
     ...
     * to this TreeTableColumn with addPropertyChangeListener().
     *
...
//
    /** 
     * As of Java 2 platform v1.3, this method is not called by the <code>TreeTableColumn</code>
     * constructor.  Previously this method was used by the
     * <code>TreeTableColumn</code> to create a default header renderer.
     * As of Java 2 platform v1.3, the default header renderer is <code>null</code>.
     * <code>TreeTableHeader</code> now provides its own shared default
     * renderer, just as the <code>TreeTable</code> does for its cell renderers.
     *
     * @return the default header renderer
     * @see javax.swing.table.TreeTableHeader#createDefaultRenderer()
     */
    protected TreeTableCellRenderer createDefaultHeaderRenderer() {
        DefaultTreeTableCellRenderer label = new DefaultTreeTableCellRenderer() {
            ...
            public Component getTreeTableCellRendererComponent(TreeTable treeTable,
                    ...
                    int row, int column, boolean hasFocus) {
                if (treeTable != null) {
