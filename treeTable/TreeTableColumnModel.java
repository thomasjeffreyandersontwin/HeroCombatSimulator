/*
 * @(#)TreeTableColumnModel.java	1.23 03/01/23
 *
 ...
 * @author Alan Chung
 * @author Philip Milne
 * @see DefaultTreeTableColumnModel
 */
...
//
    ...
    /**
     *  Deletes the <code>TreeTableColumn</code> <code>column</code> from the 
    ...
    /**
     * Sets the <code>TreeTableColumn</code>'s column margin to
...
//
     ...
     * whose modelIndex is equal to <code>modelIndex</code>,
     * when compared using <code>equals</code>.
     *
     * @param           modelIndex        the model Index 
     * @return          the index of the first table column
     *                  whose identifier is equal to <code>modelIndex</code>
     *                  or -1 if the model index is not found.
     * @see             #getColumn
     */
    ...
    /**
     * Returns the <code>TreeTableColumn</code> object for the column at
     * <code>columnIndex</code>.
     *
     * @param   columnIndex     the index of the desired column 
     * @return  the <code>TreeTableColumn</code> object for
...
//
    ...
    /** Sets the TreeTableColumnModel to be sortable.
     *
     * In addition to the model being sortable, the specific
     * columns must also be marked as sortable.  Setting
     * the value of sortable on the model does not affect
     * the sortability of the individual columns.
     *
     * @param sortable
     */
    ...
    /** Return whether the sort is currently ascending.
     *
     * @return
     */
    public boolean isSortAscending();

    /** Sets the current sort column and direction.
     *
     * The model must be sortable to see the sort column (with
     * the exception of setting the column to null).
     * <p>
     * This will result in a columnSorted listener event if
     * the column or direction changed.
     *
     * @param column
     * @param ascending
     */
    public void setSort(TreeTableColumn column, boolean ascending);
}