/*
 * @(#)VariableHeightLayoutCache.java	1.22 05/11/17
 *
...
public class TreeTableVariableHeightLayoutCache extends AbstractLayoutCache {
    /**
    ...
    public TreeTableVariableHeightLayoutCache() {
	super();
