 ...
 * @version 
 */
public class AbilityDragSource extends JLabel implements DragGestureListener, DragSourceListener {
    private Object object;
    /** Creates new TestDragSource */
    public AbilityDragSource() {
        setBorder( new LineBorder(Color.red));
        setText("Energy Blast");
 ...
 */
    public void dragGestureRecognized(DragGestureEvent dge) {
      ...
      //  object = l;
        ...
        dge.startDrag(DragSource.DefaultCopyDrop, new ObjectTransferable(a, Ability.class), this);
