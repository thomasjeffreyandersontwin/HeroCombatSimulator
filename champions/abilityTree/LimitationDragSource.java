 ...
 * @version 
 */
public class LimitationDragSource extends JLabel implements DragGestureListener, DragSourceListener {
    private Object object;
    /** Creates new TestDragSource */
    public LimitationDragSource() {
 ...
 */
    public void dragGestureRecognized(DragGestureEvent dge) {
       Limitation l = new limitationFocus();
        ...
        dge.startDrag(DragSource.DefaultCopyDrop, new ObjectTransferable(l, Limitation.class), this);
