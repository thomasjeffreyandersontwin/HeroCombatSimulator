 ...
 * In addition to <code>JMenuItem</code>s, a <code>MyMenu</code> can
 ...
 * <a href="doc-files/Key-Index.html#MyMenu">MyMenu</a> key assignments.
 * <p>
...
public class MyMenu extends JMenu 
{
    ...
    /**
     * Constructs a new <code>MyMenu</code> with no text.
     */
    public MyMenu() {
        this("");
    }
    ...
    /**
     * Constructs a new <code>MyMenu</code> with the supplied string
     * as its text.
     *
    ...
    /**
     * Constructs a new <code>MyMenu</code> with the supplied string as
    ...
    private void ensureMyPopupMenuCreated() {
       // System.out.println( "Created MyPopup");
        if (popupMenu == null) {            
            final MyMenu thisMenu = this;
            this.popupMenu = new MyPopupMenu();
     ...
     * <code>Action</code>s added to the <code>MyMenu</code>.
 ...
 /*   protected WinListener createWinListener(JPopupMenu p) {
    ...
    /** 
     * <code>setAccelerator</code> is not defined for <code>MyMenu</code>.
     ...
     * @exception Error  if invoked -- this method is not defined for MyMenu.
     *			Use <code>setMnemonic</code> instead
     *
     * @beaninfo
    ...
    public void setAccelerator(KeyStroke keyStroke) {
        throw new Error("setAccelerator() is not defined for MyMenu.  Use setMnemonic() instead.");
    }
	...
	/* The "if" block below  fixes bug #4108907.
	   ...
	   another bug: 4156858.
	   The fact that one has to special-case TABS here in MyMenu code
	   also offends me...
	   hania 23 July 1998 */
     ...
     */
    private MenuElement[] buildMenuElementArray(MyMenu leaf) {
	...
	while (true) {
	    ...
	    } else if (current instanceof MyMenu) {
		menu = (MyMenu) current;
    ...
    /**
     * Returns a string representation of this <code>MyMenu</code>. This 
     * method is intended to be used only for debugging purposes, and the 
     * content and format of the returned string may vary between      
     * implementations. The returned string may be empty but may not 
     * be <code>null</code>.
     * 
     * @return  a string representation of this MyMenu.
     */
