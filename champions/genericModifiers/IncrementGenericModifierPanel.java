 ...
 * @version
 */
public class IncrementGenericModifierPanel extends GenericModifierPanel
        implements Destroyable {
    
    
    private IncrementGenericModifier genericModifier;
    
    private transient PropertyChangeSupport propertyChangeSupport = new PropertyChangeSupport(this);
    /** Creates new form CVBasePanel */
    public IncrementGenericModifierPanel(IncrementGenericModifier genericModifier) {
        initComponents();
        setupIcons();
    ...
    public void updatePanel() {
        valueLabel.setText(Integer.toString( getAmount() ));
    ...
    public int getAmount() {
        return genericModifier.getAmount();
    }
    
    public void setAmount(int value) {
        if ( value != genericModifier.getAmount() ) {
            int oldvalue = genericModifier.getAmount();
            genericModifier.setAmount(value);
    ...
    public IncrementGenericModifier getGenericModifier() {
        return genericModifier;
    }
    
    public void setGenericModifier(IncrementGenericModifier genericModifier) {
...
// Add your handling code here:
      if ( valueText.isVisible() ) {
          valueText.setText( Integer.toString( getAmount() - 1 ) );
          valueText.setVisible(false);
...
// Add your handling code here:
      if ( valueText.isVisible() ) {
          valueText.setText( Double.toString( getAmount() + 1) );
          valueText.setVisible(false);
          valueLabel.setVisible(true);
      }
      setAmount( getAmount() + 1);
...
// Add your handling code here:
      try {
          ...
          valueText.setText( Integer.toString(getAmount()) );
          valueText.selectAll();
      }
