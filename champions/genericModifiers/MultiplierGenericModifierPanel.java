 ...
 * @version
 */
public class MultiplierGenericModifierPanel extends GenericModifierPanel
        implements Destroyable {
    
    
    private MultiplierGenericModifier genericModifier;
    ...
    public void updatePanel() {
        String s = "x "+ Double.toString( getMultiplier() );
        ...
        activeCheck.setEnabled(isEditable());
    }
    ...
    public void setMultiplier(double value) {
        if ( value != genericModifier.getMultiplier() ) {
            double oldvalue = genericModifier.getMultiplier();
            genericModifier.setMultiplier(value);
            getPropertyChangeSupport().firePropertyChange( "multiplier", oldvalue, value);
            updatePanel();
        }
    }
    ...
    public void setActive(boolean active) {
        if ( active != genericModifier.isActive() ) {
    ...
    public MultiplierGenericModifier getGenericModifier() {
        return genericModifier;
    }
    
    public void setGenericModifier(MultiplierGenericModifier genericModifier) {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(6, 6, 6)
                .addComponent(descriptionLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 93, Short.MAX_VALUE)
                .addGap(0, 0, 0)
...
// Add your handling code here:
      if ( valueText.isVisible() ) {
          valueText.setText( Double.toString( getMultiplier() / 2 ) );
          valueText.setVisible(false);
...
// Add your handling code here:
      try {
          ...
          valueText.setText( Double.toString(getMultiplier()) );
          valueText.selectAll();
      }
