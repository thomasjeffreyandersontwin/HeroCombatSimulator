 ...
 * @version
 */
public class ReflectionTargetNode extends DefaultAttackTreeNode
implements ChampionsConstants {
    ...
    public ReflectionTargetNode(String name) {
        this.name = name;
        ...
        if ( activeChild != null && activeChild.getName() == null ) {
            ...
            if ( nextNodeName != null ) {
                if ( nextNodeName.equals("Reflection Target") ) {
                    ...
                    SingleTargetNode node = new SingleTargetNode("Reflection Target");
                    node.setTargetReferenceNumber(targetReferenceNumber);
                    node.setMode(NORMAL_TARGET);
