 ...
 * @version
 */
public class ProcessStateActivationFailed extends DefaultAttackTreeNode {
    
    /** Creates new ProcessActivateAbilityNode */
    public ProcessStateActivationFailed(String name) {
        this.name = name;
    ...
    public boolean processAdvance() throws BattleEventException {
        ...
        BattleEngine.processFailedActivating(battleEvent);
