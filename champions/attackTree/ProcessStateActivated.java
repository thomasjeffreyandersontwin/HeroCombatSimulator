 ...
 * @version
 */
public class ProcessStateActivated extends DefaultAttackTreeNode {
    
    /** Creates new ProcessActivateAbilityNode */
    public ProcessStateActivated(String name) {
        this.name = name;
    ...
    private void buildChildren() {
        AttackProcessNode apn = new AttackProcessNode("Attack Process Node");
        addChild(apn);
    }
