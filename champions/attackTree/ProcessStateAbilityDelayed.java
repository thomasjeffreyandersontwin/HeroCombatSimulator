 ...
 * @version
 */
public class ProcessStateAbilityDelayed extends DefaultAttackTreeNode {
    
    /** Creates new ProcessActivateAbilityNode */
    public ProcessStateAbilityDelayed(String name) {
        this.name = name;
    ...
    public boolean processAdvance() throws BattleEventException {
        ...
        BattleEngine.processStateAbilityDelayed(battleEvent);
