 ...
 * @version
 */
public class ProcessStatePreactivateManeuver extends DefaultAttackTreeNode {

    /** Creates new ProcessActivateAbilityNode */
    public ProcessStatePreactivateManeuver(String name) {
        this.name = name;
    ...
    public boolean processAdvance() throws BattleEventException {
        ...
        BattleEngine.processStatePreactivateManeuver(battleEvent);
