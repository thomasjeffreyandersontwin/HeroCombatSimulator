 ...
 * @version 
 */
public class LinkedSetupNode extends DefaultAttackTreeNode implements ChangeListener {
    ...
    public LinkedSetupNode(String name) {
        this.name = name;
    ...
    public boolean activateNode(boolean manualOverride) {
        ...
        if ( nodeRequiresInput() || manualOverride == true ) {
            LinkedSetupPanel app = LinkedSetupPanel.getLinkedSetupPanel( (LinkedBattleEvent)getBattleEvent() );
