 ...
 * @version
 */
public class ProcessStateDeactivating extends DefaultAttackTreeNode {
    
    /** Creates new ProcessActivateAbilityNode */
    public ProcessStateDeactivating(String name) {
        this.name = name;
    ...
    public boolean processAdvance() throws BattleEventException {
        ...
        BattleEngine.processDeactivating(battleEvent);
