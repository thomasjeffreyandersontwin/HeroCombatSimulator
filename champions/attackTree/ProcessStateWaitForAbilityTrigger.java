 ...
 * @version
 */
public class ProcessStateWaitForAbilityTrigger extends DefaultAttackTreeNode {
    
    /** Creates new ProcessActivateAbilityNode */
    public ProcessStateWaitForAbilityTrigger(String name) {
        this.name = name;
    ...
    public boolean processAdvance() throws BattleEventException {
        ...
        BattleEngine.processStateWaitForAbilityTrigger(battleEvent);
