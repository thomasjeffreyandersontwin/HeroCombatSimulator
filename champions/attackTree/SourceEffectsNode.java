 ...
 * @version 
 */
public class SourceEffectsNode extends DefaultAttackTreeNode {
    ...
    public SourceEffectsNode(String name) {
        this.name = name;
    ...
    public void buildChildren() {
        ...
        for(index=0;index<count;index++) {
            ...
            atn = effect.getSourceEffectNode( battleEvent, target, tg, targetReferenceNumber);
            if ( atn != null ) {
                addChild(atn);
            }
        }
