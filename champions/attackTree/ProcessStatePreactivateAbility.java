 ...
 * @version
 */
public class ProcessStatePreactivateAbility extends DefaultAttackTreeNode {

    /** Creates new ProcessActivateAbilityNode */
    public ProcessStatePreactivateAbility(String name) {
        this.name = name;
    ...
    public boolean processAdvance() throws BattleEventException {
        ...
        BattleEngine.processStatePreactivateAbility(battleEvent);
