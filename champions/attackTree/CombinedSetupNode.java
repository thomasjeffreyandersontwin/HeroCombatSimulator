 ...
 * @version 
 */
public class CombinedSetupNode extends DefaultAttackTreeNode implements ChangeListener {
    ...
    public CombinedSetupNode(String name) {
        this.name = name;
        icon = UIManager.getIcon("AttackTree.combinedSetupIcon");
    }
    ...
    public boolean activateNode(boolean manualOverride) {
        ...
        if ( nodeRequiresInput() || manualOverride == true ) {
            CombinedSetupPanel app = CombinedSetupPanel.getCombinedSetupPanel( (CombinedAbilityBattleEvent)getBattleEvent() );
            app.addChangeListener(this);
        
            attackTreePanel.showInputPanel(this,app);
            attackTreePanel.setInstructions("Combined Powers...");
