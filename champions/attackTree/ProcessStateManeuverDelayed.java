 ...
 * @version
 */
public class ProcessStateManeuverDelayed extends DefaultAttackTreeNode {
    
    /** Creates new ProcessActivateAbilityNode */
    public ProcessStateManeuverDelayed(String name) {
        this.name = name;
    ...
    public boolean processAdvance() throws BattleEventException {
        ...
        BattleEngine.processStateManeuverDelayed(battleEvent);
