 ...
 * @version
 */
public class ProcessStateFinishing extends DefaultAttackTreeNode {
    
    /** Creates new ProcessActivateAbilityNode */
    public ProcessStateFinishing(String name) {
        this.name = name;
    ...
    public boolean processAdvance() throws BattleEventException {
        ...
        BattleEngine.processFinishedActivating(battleEvent);
