 ...
 * @version 
 */
public class CVBasePanel extends JPanel {
    ...
    public CVBasePanel(String type, Integer value) {
        initComponents ();
        setupIcons();
...
// Add your handling code here:
    ...
    public void setValue(int value) {
        if ( value != this.value ) {
            ...
            this.value = value;
            propertyChangeSupport.firePropertyChange( type + ".BASECV", oldvalue, value);
            updatePanel();
