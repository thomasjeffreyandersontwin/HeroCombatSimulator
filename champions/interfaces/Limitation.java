...
public interface Limitation extends PAD {
     ...
     *
     * Removelimitation is called prior to an Limitation being removed from an ability.  The
     ...
     */
    public void removeLimitation(Ability ability, int index);
    
    /** Attempt to identify Limitation 
    ...
    /** Attempt to Import Limitation setting from AbilityImport information.
     * @param ability Ability into which to import.
     * @param ai AbilityImport from which to grab import information.
     */    
    public void importLimitation(Ability ability, int index, AbilityImport ai, int line);
...
* Note: If the Limitation is not defined in the power already, a default parameterList
* will be generated.
