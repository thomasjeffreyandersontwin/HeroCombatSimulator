/*
 * LinkedActivateBattleEvent.java
 *
 ...
 * @author  1425
 */
public class LinkedActivateBattleEvent extends BattleEvent {
    ...
    /** Creates a new instance of LinkedActivateBattleEvent */
    public LinkedActivateBattleEvent(Target source) {
    ...
    public void addLinkedAbility( Ability ability, boolean followLinks ) {
        ...
        int index = createIndexed("LinkedAbility", "BATTLEEVENT", be);
        ...
        if ( ability.isLinked() ) {
            ...
            for(int i = 0; i < size; i++) {
                ...
                if ( hasLinkedAbility(linkedName) == false ) {
                    ...
                    if ( linkedAbility == null ) {
                        System.out.println("LinkedActivateBattleEvent.buildAbilityLinks: Ability " + linkedAbility + " not found for " + source.getName());
                        continue;
                    }
