 ...
 */
public class limitationOnlyWhenNotAttacking extends LimitationAdapter implements ChampionsConstants {
    ...
    public static String limitationName = "Only When Not Attacking"; // The Name of the Limitation
    private static boolean unique = true; // Indicates whether multiple copies can be added to ability
    
    // Import Patterns Definitions
    private static Object[][] patterns = {
        { "Only When Not Attacking:.*",null}
    };
    
    /** Creates new advCombatModifier */
    public limitationOnlyWhenNotAttacking() {
    }
    ...
    public String getConfigSummary() {
        return "Only When Not Attacking";
    }
