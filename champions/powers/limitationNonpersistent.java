 ...
 */
public class limitationNonpersistent extends LimitationAdapter implements ChampionsConstants {
    ...
    public static String limitationName = "Nonpersistent"; // The Name of the Limitation
    ...
    public limitationNonpersistent() {
    }
