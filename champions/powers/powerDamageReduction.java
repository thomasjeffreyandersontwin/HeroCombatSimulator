 ...
 */
public class powerDamageReduction extends Power 
implements ChampionsConstants {
    static final long serialVersionUID = -6720842894081061647L;
    
    static private Integer[] options = new Integer[] { new Integer(25), new Integer(50), new Integer(75) };
    static private String[] typeOptions = new String[] { "PD","ED","MD"};
        
    static private Object[][] parameterArray = {
        {"Percent","Power.PERCENT", Integer.class, new Integer(25), "Reduction %", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", options},
        {"DamageType","Power.DAMAGETYPE", String.class, "PD", "Versus", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", typeOptions},
        {"Resistent","Power.RESISTENT", Boolean.class, new Boolean(false), "Resistent", BOOLEAN_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED}
    };
    
    // Cost Array - See Power.getCostArray()
    static private Object[][] costArray = {
        { "Percent", GEOMETRIC_COST, DYNAMIC_RECONFIG, PROPORTIONAL_RECONFIG, new Integer(25), new Integer(1), new Integer(0), new Integer(0) },
    };
    
    // Power Definition Variables
    private static String powerName = "Damage Reduction"; // The Name of the Power
    ...
    private static Object[][] patterns = {
        { ".*\\((.*), ([0-9]*)%(.*)\\)", new Object[] { "DamageType", String.class, "Percent", Integer.class, "Resistent", Boolean.class}},
        //
        //HD Energy Damage Reduction, 50%
        { "(.*) Damage Reduction, (Resistant), ([0-9]*)%.*", new Object[] { "DamageType", String.class, "Resistent", Boolean.class, "Percent", Integer.class}},
        { "(.*) Damage Reduction, ([0-9]*)%.*", new Object[] { "DamageType", String.class, "Percent", Integer.class}}
    };
    /** Creates new powerHandToHandAttack */
    public powerDamageReduction()  {
    }
  ...
  */
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        String type = (String)parameterList.getParameterValue("DamageType");
        Integer percent = (Integer)parameterList.getParameterValue("Percent");
        boolean resistent = (Boolean)parameterList.getParameterValue("Resistent");
        ...
        convertDamageType(parameterList);
    ...
    public void triggerPower(BattleEvent be, Ability ability,DetailList effectList, Target target, int refNumber, String targetGroup) throws BattleEventException {
        ...
        //boolean resistent = resString.equals("TRUE")?true:false;
        
        String name = ability.getName();
        
        Effect effect = new effectDamageReduction(ability, name , percent, type, resistent);
    ...
    public int calculateCPCost(Ability ability) {
        ...
        if ( percent.intValue() == 25 ) return resistent ? 15 : 10;
        else if ( percent.intValue() == 50 ) return resistent ? 30 : 20;
        else if ( percent.intValue() == 75 ) return resistent ? 60 : 40;
    ...
    public String getConfigSummary(Ability ability, int not_used) {
        ...
        String resString2 = (resistent) ? " resistent":"" ;
        return "Damage Reduction (" + type + ", " + percent.toString() + "%" + resString2 +")"  ;
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && ( power.equals( "DAMAGEREDUCTION" ) || power.equals( "Damage Reduction" ) )){
            return 10;
        }
        return 0;
    }

    public void convertDamageType(ParameterList parameterList) {
        String type = (String)parameterList.getParameterValue("DamageType");
        if ( type.equals("Physical") ) parameterList.setParameterValue("DamageType", "PD");
        else if ( type.equals("Energy") ) parameterList.setParameterValue("DamageType", "ED");
        else if ( type.equals("Mental") ) parameterList.setParameterValue("DamageType", "MD");
    }
