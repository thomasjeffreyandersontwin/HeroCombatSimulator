 ...
 */
public class TalentAbsoluteRangeSense extends Talent 
implements ChampionsConstants {
    ...
    private static String powerName = "Absolute Range Sense"; // The Name of the Power
    ...
    public TalentAbsoluteRangeSense()  {
    }
