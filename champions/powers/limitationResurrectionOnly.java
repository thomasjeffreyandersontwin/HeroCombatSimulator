 ...
 */
public class limitationResurrectionOnly extends LimitationAdapter implements ChampionsConstants {
    ...
    public static String limitationName = "Resurrection Only"; // The Name of the Limitation
    private static String limitationDescription = "Resurrection Only"; // The Description of the Limitation
    ...
    public limitationResurrectionOnly() {
    }
