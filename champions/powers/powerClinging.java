 ...
 */
public class powerClinging extends Power 
implements ChampionsConstants {
    
    static final long serialVersionUID = -4093385577202136604L;
    
    static private Object[][] parameterArray = {
        {"Str","Power.STR", Integer.class, new Integer(0), "Clinging Strength", INTEGER_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "MINIMUM", new Integer(0) }
    ...
    static private Object[][] costArray = {
        ...
        { "Str", GEOMETRIC_COST, DYNAMIC_RECONFIG, ALL_RECONFIG, new Integer(1), new Integer(3), new Integer(0), new Integer(0) },
    };
    
    // Power Definition Variables
    private static String powerName = "Clinging"; // The Name of the Power
    ...
    private static String description = "Dude, its Clinging, ok?";
    
    // Import Patterns Definitions
    private static Object[][] patterns = {
        { ".*\\(Clinging STR \\+([0-9]*)\\)", new Object[] { "Str", Integer.class}}
    };
  ...
  */
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        Integer str = (Integer)parameterList.getParameterValue("Str");
    ...
    public void triggerPower(BattleEvent be, Ability ability, DetailList effectList, Target target, int refNumber, String TargetGroup) throws BattleEventException {
        Effect effect =  new effectClinging(ability);
   ...
   /* public int calculateCPCost(Ability ability) {
    ...
    public String getConfigSummary(Ability ability, int not_used) {
        ...
        return "Clinging (Clinging STR +" + str.toString() + ")";
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && ( power.equals( "CLINGING" ) || power.equals( "Clinging" ) )){
            return 10;
        }
        return 0;
    }
