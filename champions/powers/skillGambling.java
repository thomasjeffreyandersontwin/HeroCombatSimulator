 ...
 */
public class skillGambling extends Skill implements ChampionsConstants {
    ...
    static private String[] categoryOptions = {
        "None", "Card Games", "Dice Games", "Board Games","Roulette","Sports Betting"
    };

    static private String[] subcategoryOptions = {
        "None", "Baccarat", "Blackjack", "Bridge","Faro","Poker",
        "Craps","Backgammon","Chess","Dominoes","Baseball","Basketball",
        "Dog Racing","Football","Horse Racing"
    };
    ...
    private static String powerName = "Gambling"; // The Name of the Power
 ...
 */
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && power.equals( "GAMBLING" )){
            return 10;
        }
        return 0;
    }
