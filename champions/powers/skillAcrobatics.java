 ...
 */
public class skillAcrobatics extends Skill implements ChampionsConstants {
 ...
 */
    ...
    public void triggerPower(BattleEvent be, Ability ability, DetailList effectList, Target target, int referenceNumber, String targetGroup) throws BattleEventException {
        ...
        Effect effect =  new effectCombatModifier(ability.getName() +" modifier",bonus.intValue(),0,0,true);
