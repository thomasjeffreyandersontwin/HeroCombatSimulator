 ...
 */
public class skillCramming extends Skill implements ChampionsConstants {
    ...
    private static String powerName = "Cramming"; // The Name of the Power
    ...
    public String getConfigSummary(Ability ability, int not_used) {
        ...
        String s = stat + " based skill with 0 levels. (SR: " + stat + "/5+9)";
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && power.equals( "CRAMMING" )){
            return 10;
        }
        return 0;
    }
...
//        //dex-based skills
//        
//        if ( powername != null && powername.equals( "Cramming") ) {
//            return 10;
//        }
//        return 0;
//    }
