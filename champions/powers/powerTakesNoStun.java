 ...
 */
public class powerTakesNoStun extends Power implements ChampionsConstants {
    static final long serialVersionUID = -6720842894081061647L;
    
    static private String[] typeOptions = new String[] { "POWER LOSS","NOTHING"};
        
    static private Object[][] parameterArray = {
      //  {"DamageResults","Power.DAMAGERESULTS", String.class, "NOTHING", "Body causes", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", typeOptions},
    ...
    private static String powerName = "Takes No Stun"; // The Name of the Power
  ...
  */
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        //String type = (String)parameterList.getParameterValue("DamageResults");
    ...
    public void triggerPower(BattleEvent be, Ability ability,DetailList effectList, Target target, int refNumber, String targetGroup) throws BattleEventException {
       ...
       // String type = (String)parameterList.getParameterValue("DamageResult");
