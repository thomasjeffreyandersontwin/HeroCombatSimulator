 ...
 */
public class powerMindScan extends Power implements ChampionsConstants {
    ...
    static public String[] effectLevelOptions = {
        "Greater than EGO (the Telepath Can Read Or Send Surface Thoughts)",
        "EGO + 10 (The Telepath Can Read Deep, Hidden Thoughts)",
        "EGO + 20 (The Telpath Can Read Into The Target's Memory)",
        "EGO + 30 (The Telepath Can Read Into The Target's Subconscious)"
    };

    static public String[] effectModifierOptions = {
        "+20 (Telepathy Cannot Be Detected By Target)"
    };    
    ...
    private static String powerName = "Mind Control"; // The Name of the Power
    ...
    private static String description = "Mind Control";
    
    /** Creates new powerHandToHandAttack */
    public powerMindScan()  {
    }
    ...
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        ability.addDiceInfo( "DamageDie", die, "Mind Control Effect Roll");
...
//    }
    ...
    public void triggerPower(BattleEvent be, Ability ability,DetailList effectList, Target target, int refNumber, String targetGroup) throws BattleEventException {
        ...
        if ( dindex != -1 ) {
            ...
            ///Effect effect = new effectMindControl( dice.getStun(), ability.getName() );
    ...
    public AttackTreeNode getSetupPowerNode(BattleEvent be, Target source) {
        ...
        //create input for the use to configure level, modifier and description of
        //before attacking the target
        ParameterList pl = new ParameterList();
        //pl.addComboParameter( "Effect Level Desired", "Power.COMBOLEVELDESIRED", "Level Desired", "Level Desired", levelOptions );
        pl.addIntegerParameter( "Effect Level Desired", "Power.LEVELDESIRED", "Effect Level Desired", new Integer(1));
        pl.addIntegerParameter( "Effect Modifier", "Power.EFFECTMODIFIER", "Effect Modifier", new Integer(0));
        pl.addStringParameter( "Mind Control Description", "Power.MINDCONTROLDESC", "Mind Control Description", "Default");
        //pl.addComboParameter( "Level Description", "Power.LEVELDESC", "Level Description", "Level Desc", modifierOptions );
        
        GenericParameterNode node = new GenericParameterNode("Mind Control Parameters", pl, be, "Enter the following parameters...");
        return node;
    }
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && ( power.equals( "Mind Control" ) || power.equals( "Mind Control" ) )){
            return 10;
        }
        return 0;
    }
