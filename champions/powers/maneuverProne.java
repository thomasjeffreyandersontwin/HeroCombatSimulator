 ...
 */
public class maneuverProne extends Power implements ChampionsConstants {
    ...
    private static String powerName = "Prone"; // The Name of the Power
  ...
  */
    ...
    public String getConfigSummary(Ability ability, int not_used) {
     ...
     public void triggerPower(BattleEvent be, Ability ability, DetailList effectList, Target target, int refNumber, String TargetGroup) throws BattleEventException {
        Effect effect =  new effectKnockedDown();
 ...
 * found, the specified parameters will be Prone in the powers parameter list.  It is assumed that each 
