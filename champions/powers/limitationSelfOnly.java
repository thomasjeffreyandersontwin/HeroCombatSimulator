 ...
 */
public class limitationSelfOnly extends LimitationAdapter implements ChampionsConstants {
    ...
    public static String limitationName = "Self Only"; // The Name of the Limitation
    private static String limitationDescription = "Self Only"; // The Description of the Limitation
    ...
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        if ( ability.isTargetSelf() == true ) return false;
    ...
    */
    ...
    public void removeLimitation() {
     ...
     public Filter<Target> getTargetFilter() {
        return new SingleTargetFilter(ability.getSource());
    }
}