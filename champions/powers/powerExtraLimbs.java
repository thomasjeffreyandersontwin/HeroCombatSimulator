 ...
 */
public class powerExtraLimbs extends Power implements ChampionsConstants {
    static final long serialVersionUID =5295848681348707403L;
    
    static private Object[][] parameterArray = {
        {"NumberofLimbs","Power.NUMBEROFLIMBS", Integer.class, new Integer(1) , "Number of Extra Limbs", INTEGER_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "MINIMUM", new Integer(1)},
    };
    
    // Power Definition Variables
    private static String powerName = "Extra Limbs"; // The Name of the Power
    ...
    private static Object[][] patterns = {
        { "Extra Limbs.*", null },
        { "Number: ([0-9]*)", new Object[] { "NumberofLimbs", Integer.class} },
        
    };
    
    /** Creates new powerHandToHandAttack */
    public powerExtraLimbs()  {
    }
 ...
 */
    ...
    public String getConfigSummary(Ability ability, int not_used) {
        ...
        Integer numberoflimbs = (Integer)parameterList.getParameterValue("NumberofLimbs");
        
        
        return numberoflimbs + " " + powerName;
    }
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && ( power.equals( "EXTRALIMBS" ) || power.equals( "Extra Limbs" ) )){
            return 10;
        }
        return 0;
    }
