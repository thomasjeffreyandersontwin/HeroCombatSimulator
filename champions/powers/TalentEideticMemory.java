 ...
 */
public class TalentEideticMemory extends Talent
implements ChampionsConstants {
    ...
    private static String powerName = "Eidetic Memory"; // The Name of the Power
