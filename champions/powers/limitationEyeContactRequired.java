 ...
 */
public class limitationEyeContactRequired extends LimitationAdapter implements ChampionsConstants {
...
//        { "LinkedToAbility","LinkedToAbility*.ABILITY", Ability.class, null, "Abilities aided to", LIST_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED}
    ...
    public static String limitationName = "Eye Contact Required"; // The Name of the Limitation
    private static boolean unique = true; // Indicates whether multiple copies can be added to ability
    
    // Import Patterns Definitions
    private static Object[][] patterns = {
        { "Eye Contact Required.*",null}
    };
    
    /** Creates new advCombatModifier */
    public limitationEyeContactRequired() {
    }
    
    public String getName() {
        return "Eye Contact Required";
    }
    ...
    public int identifyLimitation(AbilityImport ai,int line) {
        ...
        if ( possibleLimitation != null && possibleLimitation.indexOf( "Eye Contact Required" ) != -1 ) {
            return 10;
        }
        else return 0;
