 ...
 */
public class disadvantageSocialLimitation extends Disadvantage implements ChampionsConstants {
    ...
    static public String[] restrictionsOptions = {"Minor","Major","Severe"};
    
    static private Integer[] restrictionsCostArray = new Integer[] { new Integer(0), new Integer(5), new Integer(10) };
    ...
    static private Object[][] parameterArray = {
        ...
        {"Restrictions","Disadvantage.RESTRICTIONS", String.class, "Minor", "Attack Is", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", restrictionsOptions},
        {"NotLimitingInSomeCultures","Disadvantage.NOTLIMITINGINSOMECULTURES", Boolean.class, new Boolean(false), "Not Limiting In Some Cultures", BOOLEAN_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
    };
    
    // Cost Array - See Power.getCostArray()
    static private Object[][] costArray = {
        { "Restrictions", COMBO_COST, STATIC_RECONFIG, ZERO_RECONFIG, restrictionsCostArray, restrictionsOptions },
        { "ActivationRoll", COMBO_COST, STATIC_RECONFIG, ZERO_RECONFIG, levelsCostArray, levels },
        { "NotLimitingInSomeCultures", BOOLEAN_COST, DYNAMIC_RECONFIG, ZERO_RECONFIG, new Integer(-5)},
    };
    // Power Definition Variables
    private static String powerName = "Social Limitation"; // The Name of the Power
    ...
    private static Object[][] patterns = {
        { "OCCUR: .*\\(([0-9]*)-.*", new Object[] {"ActivationRoll", String.class}},
        { "EFFECTS: (.*)", new Object[] {"Restrictions", String.class}},
        { "(NOTINSOME).*", new Object[] {"NotLimitingInSomeCultures", Boolean.class}},
    };
    
    /** Creates new powerHandToHandAttack */
    public disadvantageSocialLimitation()  {
    }
    ...
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        String circumstance = (String)parameterList.getParameterValue("Restrictions");
        ...
        if (circumstance.startsWith("Uncommon")) {
            parameterList.setParameterValue("Restrictions", "Uncommon Circumstance");
        }
        if (circumstance.startsWith("Common")) {
            parameterList.setParameterValue("Restrictions", "Common Circumstance");
        }
        if (circumstance.startsWith("Very Common")) {
            parameterList.setParameterValue("Restrictions", "Very Common Circumstance");
        }
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && power.equals( "SOCIALLIMITATION" )){
            return 10;
        }
        return 0;
    }
