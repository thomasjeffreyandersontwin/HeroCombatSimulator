 ...
 */
public class limitationHandToHand extends LimitationAdapter implements ChampionsConstants {
...
//        { "LinkedToAbility","LinkedToAbility*.ABILITY", Ability.class, null, "Abilities aided to", LIST_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED}
    ...
    public static String limitationName = "Hand-To-Hand"; // The Name of the Limitation
    ...
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        // This is a stupid limitation that only applies to Hand-to-Hand attack
        // power...
        if ( ability.getPower() instanceof powerHandToHandAttack == false ) {
            return false;
        }
