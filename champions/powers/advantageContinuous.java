 ...
 */
public class advantageContinuous extends AdvantageAdapter implements ChampionsConstants {
  ...
  //  {"MaxShots","Ability.MAXSHOTS", Integer.class, new Integer(5), "Max Shots", INTEGER_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "MINIMUM", new Integer(2)}
    ...
    public static String advantageName = "Continuous"; // The Name of the Advantage
   ...
   // Import Patterns Definitions
    ...
    public int identifyAdvantage(AbilityImport ai, int line) {
        ...
        if ( possibleAdvantage != null && (possibleAdvantage.indexOf("CONTINUOUS") != -1 || possibleAdvantage.indexOf("Continuous") != -1)) return 1;
        return 0;
    }
