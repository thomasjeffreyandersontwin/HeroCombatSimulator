 ...
 */
public class skillScienceSkill extends Skill implements ChampionsConstants, BackgroundSkill {
    static final long serialVersionUID =5295828683348707403L;
    
    static public String[] statOptions = {"GENERAL", "INT" };
    
    static private Object[][] parameterArray = {
        {"Science","Power.SCIENCE", String.class, "", "Science", STRING_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "FIELDWIDTH", 200},
        {"BaseStat","Power.STAT", String.class, "GENERAL", "Base Stat", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", statOptions},
    ...
    private static String powerName = "Science Skill"; // The Name of the Power
    ...
    public String getConfigSummary(Ability ability, int not_used) {
        ...
        String science = (String)parameterList.getParameterValue("Science");
        Integer levels = (Integer)parameterList.getParameterValue("Levels");
        
        String s;
        
        if ( stat.equals("GENERAL") ) {
            s = "General science skill in " + science + ", " + levels.toString() + " level(s). (Skill Roll: " + (8 + levels) + ")";
        } else {
            s = stat + " science skill in " + science + ", " + levels.toString() + " level(s). (Skill Roll: " + stat + "/5 + " + (9+levels) + ")";
        }
        return s;
    }
