 ...
 */
public class maneuverDodge extends Power 
implements ChampionsConstants {
    ...
    private static String powerName = "Dodge"; // The Name of the Power
    ...
    private static Object[][] patterns = {
     //   { ".*\\(OCV --, DCV ([-+][0-9]*)\\)", new Object[] { "DCVModifier", Integer.class}}
    };
    
    /** Creates new maneuverDodge */
    public maneuverDodge() {
    }
  ...
  */
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
       ...
       parameterList.copyValues(ability);
        ...
        ability.setPowerDescription("Dodge");
 ...
 */
    ...
    public void importPower(Ability ability, AbilityImport ai) {
        ...
        String matchPattern = ".*\\(OCV --, DCV ([-+][0-9]*)?.*\\)";
        ...
        for(index=0;index<count;index++) {
            ...
            if ( ChampionsMatcher.matches(matchPattern, line) ) {
              ...
              //  int ocv = ChampionsMatcher.getIntMatchedGroup(1);
                int dcv = ChampionsMatcher.getIntMatchedGroup(1);
