 ...
 */
public class powerShrinking extends Power implements ChampionsConstants {
    static final long serialVersionUID = 7766760921350027676L;
    
    static private Object[][] parameterArray = {      
        {"Level","Power.LEVEL", Integer.class, new Integer(1), "Shrinking Levels", INTEGER_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED}
        
    };
    
    // Cost Array - See Power.getCostArray()
    static private Object[][] costArray = {
        { "Level", GEOMETRIC_COST, DYNAMIC_RECONFIG, PROPORTIONAL_RECONFIG, new Integer(10), new Integer(1), new Integer(0), new Integer(0) },
    };
    ...
    private static String powerName = "Shrinking"; // The Name of the Power
    ...
    private static String description = "Shrinking";
    ...
    private static Object[][] patterns = {
        ...
        { "Mass.*", null },
        { "Height.*", null },
        { "Knockback Increase: .*", null },
        { "PER Bonus: .*", null }
    };
    
    /** Creates new powerHandToHandAttack */
    public powerShrinking()  {
    }
  ...
  */
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        ability.add("Power.DCVBONUS",  new Integer(2 * level.intValue()),  true);
        ...
        // Add Extra Value/Pairs used by the Power/BattleE
        //ability.add("Power.DCVBONUS",  new Integer(2 * level.intValue()),  true);
...
*/    
    public String getConfigSummary(Ability ability, int not_used) {
        ...
        return powerName + "-" + level.toString() + ", +" +  new Integer(level.intValue()*2).toString() + " DCV";
    }
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && ( power.equals( "SHRINKING" ) || power.equals( "Shrinking" ) )){
            return 10;
        }
        return 0;
    }
    ...
    public void triggerPower(BattleEvent be, Ability ability, DetailList effectList, Target target, int refNumber, String targetGroup) throws BattleEventException {
        Effect effect = new effectShrinking ( ability );
