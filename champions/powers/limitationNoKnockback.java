 ...
 */
public class limitationNoKnockback extends LimitationAdapter implements ChampionsConstants {
    ...
    {"NoKnockback","Limitation#.NOKNOCKBACK", Boolean.class, new Boolean(true), "No Knockback", BOOLEAN_PARAMETER, HIDDEN, ENABLED, NOTREQUIRED},
   };

    // Limitation Definition Variables
    public static String limitationName = "No Knockback"; // The Name of the Limitation
    private static String limitationDescription = "No Knockback"; // The Description of the Limitation
