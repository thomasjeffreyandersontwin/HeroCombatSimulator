 ...
 */
public class limitationNormalRange extends LimitationAdapter implements ChampionsConstants {
...
//        { "LinkedToAbility","LinkedToAbility*.ABILITY", Ability.class, null, "Abilities aided to", LIST_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED}
    ...
    public static String limitationName = "Normal Range"; // The Name of the Limitation
    ...
    public int identifyLimitation(AbilityImport ai,int line) {
        ...
        if ( possibleLimitation != null && possibleLimitation.indexOf( "Normal Range" ) != -1 ) {
            return 10;
        }
        else return 0;
