 ...
 */
public class powerUnstun extends Power 
implements ChampionsConstants {
    static final long serialVersionUID = 2367915068243672953L;

    static private Object[][] parameterArray = {
    };
    
    // Power Definition Variables
    private static String powerName = "Unstun"; // The Name of the Power
  ...
  */
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        ability.setPowerDescription("Unstun");
    ...
    public void triggerPower(BattleEvent be, Ability ability,DetailList effectList, Target target, int refNumber, String targetGroup) throws BattleEventException {        
        if ( target.isStunned() ) {
            target.removeEffect( be, "Stunned" );
        }
    }
    ...
    public boolean isEnabled(Ability ability, Target target) {
        ...
        if ( Battle.currentBattle != null ) {
            ...
            if ( target.isStunned() != true ) {
                ability.setEnableMessage("Character isn't stunned");
                return false;
            }
        }
        return true;
