 ...
 */
public class powerSwinging extends Power
implements ChampionsConstants {
    static final long serialVersionUID = 7666760941350027676L;
    
    static private Object[][] parameterArray = {
        {"DistanceFromCollision","Ability.MOVEDISTANCE", Integer.class, new Integer(2), "Swinging DistanceFromCollision", INTEGER_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "MINIMUM", new Integer(0)},
    ...
    private static String powerName = "Swinging"; // The Name of the Power
  ...
  */
    ...
    public String getConfigSummary(Ability ability, int not_used) {
        ...
        if ( base ) {
            return "Swinging (" + Integer.toString( distance.intValue()) + "\", " + distance.toString() + "\", NC: " + Integer.toString( distance.intValue() * noncombatX.intValue() ) + "\")";
        }
        else {
            return "Swinging (" + Integer.toString( distance.intValue()  ) + "\"" + ( addsToBase ? " + base" : "") + ", NC: " + Integer.toString( distance.intValue() * noncombatX.intValue() ) + "\")";            
        }    
    }
    ...
    public int getMovementDistance(Ability ability) {
       ...
       // Integer noncombatX = (Integer)parameterList.getParameterValue("NoncombatX");
        ...
        if ( addsToBase ) {
            ...
            if ( source != null ) {
                Ability baseSwinging = source.getAbilityList().getAbility("Swinging", true);
                if ( baseSwinging.getPower() != this ) {
                    totalDistance += baseSwinging.getRange();
                }
            }
        }
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && ( power.equals( "Swinging" ) || power.equals( "Swinging" ) )){
            return 10;
        }
        return 0;
    }    
