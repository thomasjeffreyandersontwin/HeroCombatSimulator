 ...
 */
public class advantageCostsENDOnlyToActivate extends AdvantageAdapter implements ChampionsConstants {
    static final long serialVersionUID = -6391128353213532319L;
    ...
    public static String advantageName = "Costs END Only To Activate"; // The Name of the Advantage
   ...
   // Import Patterns Definitions
    ...
    public advantageCostsENDOnlyToActivate() {
    }
    ...
    public String getConfigSummary() {
        return "Costs END Only To Activate";
