 ...
 * @version
 */
public class effectBurnedout extends Effect {
    
    /** Creates new effectUnconscious */
    static private Ability unjam = null;
    
    public effectBurnedout(Ability ability) {
        super( ability.getName() +" Burned out", "PERSISTENT", true);
        // super( "Burnedout", "PERSISTENT", true);
        setAbility(ability);
        setUnique(true);
        setCritical(true);
    ...
    public boolean addEffect(BattleEvent be, Target t)  throws BattleEventException {
        ...
        if ( added ) {
            be.addBattleMessage( new champions.battleMessage.LegacyBattleMessage(t.getName() + " is Burnedout!", BattleEvent.MSG_NOTICE)); // .addBattleMessage( new champions.battleMessage.LegacyBattleMessage(t.getName() + " is Burnedout!", BattleEvent.MSG_NOTICE)); // .addMessage(t.getName() + " is Burnedout!", BattleEvent.MSG_NOTICE);
        }
        return added;
    }
    ...
    public void removeEffect(BattleEvent be, Target t)  throws BattleEventException {
        ...
        be.addBattleMessage( new champions.battleMessage.LegacyBattleMessage(t.getName() + " is no longer Burnedout!", BattleEvent.MSG_NOTICE)); // .addBattleMessage( new champions.battleMessage.LegacyBattleMessage(t.getName() + " is no longer Burnedout!", BattleEvent.MSG_NOTICE)); // .addMessage(t.getName() + " is no longer Burnedout!", BattleEvent.MSG_NOTICE);
    }
    ...
    public void addActions(Vector actions) {
        ...
        Action assignAction = new AbstractAction("Repair " + ability.getName()) {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                BattleEvent newbe = new BattleEvent(BattleEvent.REMOVE_EFFECT, effectBurnedout.this, effectBurnedout.this.getTarget());
