 ...
 */
public class skillAnalyze extends Skill implements ChampionsConstants {
    ...
    static private Object[][] parameterArray = {
        {"Description","Power.DESCRIPTION", String.class, "<what is being analyzed>", "Analyze", STRING_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
    ...
    private static String powerName = "Analyze"; // The Name of the Power
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && power.equals( "ANALYZE" )){
            return 10;
        }
        return 0;
    }
 ...
 */
    ...
    public void triggerPower(BattleEvent be, Ability ability, DetailList effectList, Target target, int referenceNumber, String targetGroup) throws BattleEventException {
        Effect effect = new effectAnalyzing(ability, target );
