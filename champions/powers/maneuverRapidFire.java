 ...
 */
public class maneuverRapidFire extends Power implements ChampionsConstants {
    ...
    private static String powerName = "Rapid Fire"; // The Name of the Power
  ...
  */
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
     ...
     //   ability.addDiceInfo( "DamageDie", "", "Attack Damage");
        ...
        ability.setIs( "RANGEDMANEUVER",true);
    ...
    public BattleEvent getActivateManeuverBattleEvent(Ability ability, Ability maneuver, Target source) {
        ...
        SweepBattleEvent sbe = new SweepBattleEvent(source, SweepBattleEvent.SweepType.RAPIDFIRE, maneuver);
        sbe.setAbilityFilter( new RapidFireAbilityFilter(source) );
    ...
    public BattleEvent getActivateAbilityBattleEvent(Ability ability, Ability maneuver, Target source) {
        ...
        if ( source == null && Battle.currentBattle != null ) source = Battle.currentBattle.getActiveTarget();
        SweepBattleEvent sbe = new SweepBattleEvent(source, SweepBattleEvent.SweepType.RAPIDFIRE, ability);
        sbe.setAbilityFilter( new RapidFireAbilityFilter(source) );
    ...
    public static class RapidFireAbilityFilter extends RangedAbilityFilter {
        ...
        public boolean includeElement(Ability ability) {
            ...
            if ( ability.getPower() instanceof maneuverRapidFire ) return false;
