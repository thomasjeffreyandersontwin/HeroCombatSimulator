 ...
 */
public class disadvantageNormalCharacteristicMaxima extends Disadvantage implements ChampionsConstants {
...
//        { "Base", BASE_COST, STATIC_RECONFIG, ZERO_RECONFIG, new Integer(20) },
    };
    
    // Power Definition Variables
    private static String powerName = "Normal Characteristic Maxima"; // The Name of the Power
    ...
    public disadvantageNormalCharacteristicMaxima()  {
    }
    ...
    public String getConfigSummary(Ability ability, int not_used) {
        return "Normal Characteristic Maxima";
    }
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && power.equals( "NCM" )){
            return 10;
        }
        return 0;
    }
