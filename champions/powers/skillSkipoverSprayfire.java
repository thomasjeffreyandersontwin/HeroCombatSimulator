 ...
 */
public class skillSkipoverSprayfire extends Skill implements ChampionsConstants {
    ...
    private static String powerName = "Skipover Sprayfire"; // The Name of the Power
    ...
    public void triggerPower(BattleEvent be, Ability ability, DetailList effectList, Target target, int referenceNumber, String targetGroup) throws BattleEventException {
        Effect effect =  new effectSkipoverSprayfire("Skipover Sprayfire");
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && power.equals( "SKIPOVERSPRAYFIRE" )){
            return 10;
        }
        return 0;
    }    
