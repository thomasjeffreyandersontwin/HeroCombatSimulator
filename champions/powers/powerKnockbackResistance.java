 ...
 */
public class powerKnockbackResistance extends Power 
implements ChampionsConstants {
    static final long serialVersionUID = 7766650941350027676L;

    static private Object[][] parameterArray = {
    {"Resistance","Knockback.RESISTANCE", Integer.class, new Integer(1), "Knockback Resistance", INTEGER_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},

    };
    
    // Cost Array - See Power.getCostArray()
    static private Object[][] costArray = {
        { "Resistance", GEOMETRIC_COST, DYNAMIC_RECONFIG, PROPORTIONAL_RECONFIG, new Integer(2), new Integer(1), new Integer(0), new Integer(0) },
    };
    ...
    private static String powerName = "Knockback Resistance"; // The Name of the Power
    ...
    private static String description = "Knockback Resistance";

    // Import Patterns Definitions
    private static Object[][] patterns = {
        { ".*\\(-(-[0-9]*)\"\\)", new Object[] { "Resistance", Integer.class}},
        { ".*\\(-([0-9]*)\"\\)", new Object[] { "Resistance", Integer.class}},
        { "Knockback Resistance -([0-9]*).*", new Object[] { "Resistance", Integer.class}},
    };
    
    /** Creates new powerHandToHandAttack */
    public powerKnockbackResistance()  {
    }
  ...
  */
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        Integer resistance = (Integer)parameterList.getParameterValue("Resistance");
...
*/
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && ( power.equals( "KBRESISTANCE" ) || power.equals( "Knockback Resistance" ) )){
            return 10;
        }
        return 0;
    }
    ...
    public void triggerPower(BattleEvent be, Ability ability,DetailList effectList, Target target, int refNumber, String targetGroup) throws BattleEventException {
        Effect effect = new effectKnockbackResistance( ability );
...
/*    
    public boolean checkParameter(Ability ability, int not_used, String key, Object value, Object oldValue) {
        if ( ((Integer)value).intValue() < 0 ) return false;
        return true;
    }
*/    
