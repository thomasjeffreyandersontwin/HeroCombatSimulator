 ...
 */
public class powerSuperleap extends Power
implements ChampionsConstants {
    ...
    private static String powerName = "Superleap"; // The Name of the Power
  ...
  */
    ...
    public int getMovementDistance(Ability ability) {
        ...
        if ( source != null ) {
            str = source.getCurrentStat( "STR" );
        }
        
        return str / 5 + distance.intValue();
    }
