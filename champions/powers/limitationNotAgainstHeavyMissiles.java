 ...
 */
public class limitationNotAgainstHeavyMissiles extends LimitationAdapter implements ChampionsConstants {
    ...
    {"NotAgainstHeavy","Limitation#.NOTAGAINSTHEAVY", Boolean.class, new Boolean(true), "Will Not Work Against Heavy Missiles", BOOLEAN_PARAMETER, HIDDEN, ENABLED, NOTREQUIRED},
   };

    // Limitation Definition Variables
    public static String limitationName = "Will Not Work Against Heavy Missiles"; // The Name of the Limitation
    private static String limitationDescription = "Will Not Work Against Heavy Missiles"; // The Description of the Limitation
    ...
    public limitationNotAgainstHeavyMissiles() {
    }
...
//        boolean noknockback = (Boolean)parameterList.getParameterValue("NoKnockback");
...
//        }
    ...
    public String getConfigSummary() {
        return "Will Not Work Against Heavy Missiles";
    }
...
//        ability.remove("Ability.NOKNOCKBACK");
    }
}