 ...
 */
public class skillCombatPiloting extends Skill implements ChampionsConstants {
    ...
    private static String powerName = "Combat Piloting"; // The Name of the Power
...
//    }
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && power.equals( "COMBAT_PILOTING" )){
            return 10;
        }
        return 0;
    }    
