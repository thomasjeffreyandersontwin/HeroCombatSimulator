 ...
 */
public class powerFlightconstant extends Power implements ChampionsConstants {
...
//        { "Base", BASE_COST, STATIC_RECONFIG, ZERO_RECONFIG, new Integer(10) },
    ...
    private static String powerName = "Flight"; // The Name of the Power
    ...
    private static String description = "Flight";
    
    /** Creates new powerHandToHandAttack */
    public powerFlightconstant()  {
    }
