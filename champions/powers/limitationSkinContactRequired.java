 ...
 */
public class limitationSkinContactRequired extends LimitationAdapter implements ChampionsConstants {
...
//        { "LinkedToAbility","LinkedToAbility*.ABILITY", Ability.class, null, "Abilities aided to", LIST_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED}
    ...
    public static String limitationName = "Skin Contact Required"; // The Name of the Limitation
    private static boolean unique = true; // Indicates whether multiple copies can be added to ability
    
    // Import Patterns Definitions
    private static Object[][] patterns = {
        { "Skin Contact Required.*",null}
    };
    
    /** Creates new advCombatModifier */
    public limitationSkinContactRequired() {
    }
    
    public String getName() {
        return "Skin Contact Required";
    }
    ...
    public int identifyLimitation(AbilityImport ai,int line) {
        ...
        if ( possibleLimitation != null && possibleLimitation.indexOf( "Skin Contact Required" ) != -1 ) {
            return 10;
        }
        else return 0;
