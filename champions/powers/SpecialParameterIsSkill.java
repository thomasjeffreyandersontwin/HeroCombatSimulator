 ...
 * @version
 */
public class SpecialParameterIsSkill extends SpecialParameterAdapter implements ChampionsConstants {
    ...
    private static String specialParameterName = "Is a Skill"; // The Name of the SpecialParameter
    private static boolean unique = true; // Indicates whether multiple copies can be added to ability
    

    public SpecialParameterIsSkill() {
