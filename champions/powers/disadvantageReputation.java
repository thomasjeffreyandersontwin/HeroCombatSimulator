 ...
 */
public class disadvantageReputation extends Disadvantage implements ChampionsConstants {
    static final long serialVersionUID =5295848683348706403L;
    
    static public String[] levelOptions = {"8","11","14"};
    
    static private Integer[] levelCostArray = new Integer[] { new Integer(5), new Integer(10), new Integer(15) };
    
    static private Object[][] parameterArray = {
        {"ActivationRoll","Disadvantage.LEVEL", String.class, "8", "Attack Is", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", levelOptions},
        {"ExtremeReputation","Disadvantage.EXTREMEREPUTATION", Boolean.class, new Boolean(false), "Extreme Reputation", BOOLEAN_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
        {"KnownToASmallLimitedGroup","Disadvantage.KNOWNTOASMALLLIMITEDGROUP", Boolean.class, new Boolean(false), "Known Only To a Small or Limited Group", BOOLEAN_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
    };
    
    // Cost Array - See Power.getCostArray()
    static private Object[][] costArray = {
        { "ActivationRoll", COMBO_COST, STATIC_RECONFIG, ZERO_RECONFIG, levelCostArray, levelOptions },
        { "ExtremeReputation", BOOLEAN_COST, DYNAMIC_RECONFIG, ZERO_RECONFIG, new Integer(5)},
        { "KnownToASmallLimitedGroup", BOOLEAN_COST, DYNAMIC_RECONFIG, ZERO_RECONFIG, new Integer(-5)},
    };
    // Power Definition Variables
    private static String powerName = "Reputation"; // The Name of the Power
    ...
    private static Object[][] patterns = {
        //{ "RECOGNIZED:.*([0-9]*)-.*", new Object[] {"Level", String.class}},
        { "RECOGNIZED.*\\(([0-9]*)-.*", new Object[] {"ActivationRoll", String.class}},
        { "(EXTREME).*", new Object[] {"ExtremeReputation", Boolean.class}},
        { "(NOTALL).*", new Object[] {"KnownToASmallLimitedGroup", Boolean.class}},
    };
    
    /** Creates new powerHandToHandAttack */
    public disadvantageReputation()  {
    }
    ...
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        String recognized = (String)parameterList.getParameterValue("ActivationRoll");
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && power.equals( "REPUTATION" )){
            return 10;
        }
        return 0;
    }
