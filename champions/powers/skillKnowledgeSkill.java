 ...
 */
public class skillKnowledgeSkill extends Skill implements ChampionsConstants, BackgroundSkill {
    static final long serialVersionUID =5295828683348707403L;
    
    static public String[] statOptions = {"GENERAL","INT"};
    ...
    static private Object[][] parameterArray = {
        ...
        {"Knowledge","Power.Knowledge", String.class, "", "Knowledge", STRING_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
        };
        ...
        private static String powerName = "Knowledge Skill"; // The Name of the Power
        ...
        static private Object[][] costArray = {
            ...
            { "Levels", GEOMETRIC_COST, DYNAMIC_RECONFIG, PROPORTIONAL_RECONFIG, new Integer(1), new Integer(1), new Integer(0), new Integer(0) },
        };
        
        /** Creates new powerHandToHandAttack */
        public skillKnowledgeSkill()  {
        }
     ...
     */
        ...
        public String getConfigSummary(Ability ability, int not_used) {
            ...
            if ( stat.equals("General") ) {
                String s = 11 + " based skill with" + levels.toString() + " levels. (SR: " + 11 + Integer.toString(levels.intValue() + 11) + ")"; 
            return s;
            }
...
//    }
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && power.equals( "KNOWLEDGE_SKILL" )){
            return 10;
        }
        return 0;
    }
