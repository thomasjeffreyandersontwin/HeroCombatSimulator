 ...
 */
public class advantageVaryingEffect extends AdvantageAdapter implements ChampionsConstants {
    ...
    public static String advantageName = "Varying Effect"; // The Name of the Advantage
