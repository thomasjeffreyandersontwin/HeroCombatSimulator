 ...
 */
public class limitationFillInAlwaysOccurs extends LimitationAdapter implements ChampionsConstants {
    ...
    public static String limitationName = "Fill In Always Occurs"; // The Name of the Limitation
    ...
    public limitationFillInAlwaysOccurs() {
    }
