 ...
 * @version
 */
public class SpecialParameterAlwaysTargetSelf extends SpecialParameterAdapter implements ChampionsConstants {
    ...
    private static String specialParameterName = "Always Target Self"; // The Name of the SpecialParameter
    private static boolean unique = true; // Indicates whether multiple copies can be added to ability
    

    public SpecialParameterAlwaysTargetSelf() {
