 ...
 * @version
 */
public class SpecialParameterSTRMinimum extends SpecialParameterAdapter implements ChampionsConstants {
    ...
    private static String specialParameterName = "STR Minimum"; // The Name of the SpecialParameter
    private static boolean unique = true; // Indicates whether multiple copies can be added to ability
    

    public SpecialParameterSTRMinimum() {
