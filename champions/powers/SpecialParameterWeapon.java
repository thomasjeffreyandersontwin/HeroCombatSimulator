 ...
 * @version
 */
public class SpecialParameterWeapon extends SpecialParameterAdapter implements ChampionsConstants {
    ...
    static private Object[][] parameterArray = {
        {"Weapon", "Ability.ISWEAPON", Boolean.class, new Boolean(true), "Is Weapon", BOOLEAN_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
    ...
    public static String specialParameterName = "Is Weapon"; // The Name of the SpecialParameter
    private static boolean unique = true; // Indicates whether multiple copies can be added to ability
    

    public SpecialParameterWeapon() {
    ...
    public boolean configure(Ability ability, ParameterList parameterList) {
        ...
        boolean weapon = (Boolean)parameterList.getParameterValue("Weapon");
 ...
 */
    ...
    public int identifySpecialParameter(AbilityImport ai, int line) {
        ...
        if ( possibleSpecialParameter != null && possibleSpecialParameter.startsWith( "STR Min" )  ) {
            return 10;
        }
