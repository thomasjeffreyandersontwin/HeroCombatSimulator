 ...
 */
public class powerDoesNotBleed extends Power implements ChampionsConstants {
    ...
    static private Object[][] costArray = {
        { "Base", BASE_COST, STATIC_RECONFIG, ZERO_RECONFIG, new Integer(15) },
    };
    
    // Power Definition Variables
    private static String powerName = "Does Not Bleed"; // The Name of the Power
  ...
  */
    ...
    public void triggerPower(BattleEvent be, Ability ability,DetailList effectList, Target target, int refNumber, String targetGroup) throws BattleEventException {
       ...
       // String type = (String)parameterList.getParameterValue("DamageResult");
        ...
        Effect effect = new effectDoesNotBleed(name);
