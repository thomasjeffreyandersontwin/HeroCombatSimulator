 ...
 */
public class skillStandardCharBased extends Skill implements ChampionsConstants {
    ...
    static private Object[][] parameterArray = {
        {"BaseStat","Power.STAT", String.class, "STR", "Base Stat", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", statOptions},
        ...
        private static String powerName = "Standard Char-based Skill"; // The Name of the Power
     ...
     */
        ...
        public int getSkillRoll(Ability ability, Target target) {
            ...
            if ( target.hasStat(stat) ) {
                statValue = target.getCurrentStat(stat);
            }
            else {
                System.out.println("Warning: " + target.getName() + " does not have stat " + stat + " required for skill roll");
            }
...
//    }
        ...
        public void importPower(Ability ability, AbilityImport ai) {
            ...
            if (powername.equals("Lip Reading")) {
                ability.setName("lipreading");
            }
            powername = (String)ai.getValue("AbilityImport.POWERNAME");
            int index = -1;
            
            //dex-based skills
            if ( powername.equals( "Combat Driving" )
            ||  powername.equals( "Combat Piloting" )
            ||  powername.equals( "Contortionist" )
            ||  powername.equals( "Fast Draw" )
            ||  powername.equals( "Lockpicking" )
            ||  powername.equals( "Riding" )
            ||  powername.equals( "Teamwork" )
            
            ||  powername.equals( "COMBAT_DRIVING")
            ||  powername.equals( "COMBAT_PILOTING" )
            ||  powername.equals( "CONTORTIONIST" )
            ||  powername.equals( "FAST_DRAW" )
            ||  powername.equals( "LOCKPICKING" )
            ||  powername.equals( "RIDING" )
            ||  powername.equals( "TEAMWORK" )
            ) {
            ...
            else if ( powername.equals( "Bugging" )
            ||  powername.equals( "Computer Programming" )
            ||  powername.equals( "Concealment" )
            ||  powername.equals( "Criminology" )
            ||  powername.equals( "Cryptography" )
            ||  powername.equals( "Deduction" )
            ||  powername.equals( "Demolitions" )
            ||  powername.equals( "Electronics" )
            ||  powername.equals( "Forensic Medicine" )
            ||  powername.equals( "Inventor" )
            ||  powername.equals( "Lipreading" )
            ||  powername.equals( "Lip Reading" )
            ||  powername.equals( "Mechanics" )
            ||  powername.equals( "Mimicry" )
            ||  powername.equals( "Paramedics" )
            ||  powername.equals( "Security Systems" )
            ||  powername.equals( "Shadowing" )
            ||  powername.equals( "Systems Operation" )
            ||  powername.equals( "Tactics" )
            ||  powername.equals( "Tracking" )
            ||  powername.equals( "Ventriloquism" )
            
            ||  powername.equals( "BUGGING" )
            ||  powername.equals( "COMPUTER_PROGRAMMING" )
            ||  powername.equals( "CONCEALMENT" )
            ||  powername.equals( "CRIMINOLOGY" )
            ||  powername.equals( "CRYPTOGRAPHY" )
            ||  powername.equals( "DEDUCTION" )
            ||  powername.equals( "DEMOLITIONS" )
            ||  powername.equals( "ELECTRONICS" )
            ||  powername.equals( "FORENSIC_MEDICINE" )
            ||  powername.equals( "INVENTOR" )
            ||  powername.equals( "LIPREADING" )
            ||  powername.equals( "MECHANICS" )
            ||  powername.equals( "MIMICRY" )
            ||  powername.equals( "PARAMEDICS" )
            ||  powername.equals( "SECURITY_SYSTEMS" )
            ||  powername.equals( "SHADOWING" )
            ||  powername.equals( "SYSTEMS_OPERATION" )
            ||  powername.equals( "TACTICS" )
            ||  powername.equals( "TRACKING" )
            ||  powername.equals( "VENTRILOQUISM" )
                ...
                parameterList.setParameterValue("BaseStat", "INT" );
                CharacterImport ci = (CharacterImport)ai.getValue("AbilityImport.CHARACTERIMPORT");
                
                // Find the location of the DEX information in the import
                index = ci.findIndexed("Stat","NAME","INT");
                if ( index != -1 ) {
                    // Grab the EGO value and calculate the base MDF
                    Integer currentstat = ci.getIndexedIntegerValue(index,"Stat","VALUE");
                    Integer level = new Integer(rollimport.intValue() - ChampionsUtilities.roundValue(currentstat.doubleValue()/5.0, false) - 9);
            ...
            //per-based skills
            else if (  powername.equals( "Bribery" )
            ||  powername.equals( "Bureaucratics" )
            ||  powername.equals( "Conversation" )
            ||  powername.equals( "High Society" )
            ||  powername.equals( "Interrogation" )
            ||  powername.equals( "Oratory" )
            ||  powername.equals( "Persuasion" )
            ||  powername.equals( "Power" )
            ||  powername.equals( "Seduction" )
            ||  powername.equals( "Streetwise" )
            ||  powername.equals( "Trading" )
            
            ||  powername.equals( "BRIBERY" )
            ||  powername.equals( "BUREAUCRATICS" )
            ||  powername.equals( "CONVERSATION" )
            ||  powername.equals( "HIGH_SOCIETY" )
            ||  powername.equals( "INTERROGATION")
            ||  powername.equals( "ORATORY" )
            ||  powername.equals( "PERSUASION" )
            ||  powername.equals( "POWER" )
        ...
        public int identifyPower(Ability template, AbilityImport ai) {
            String powername = ai.getPowerName();
            
            //dex-based skills
            
            if ( powername != null &&
            (   powername.equals( "Combat Driving" )
            ||  powername.equals( "Combat Piloting" )
            ||  powername.equals( "Contortionist" )
            ||  powername.equals( "Lockpicking" )
            ||  powername.equals( "Riding" )
            ||  powername.equals( "Sleight of Hand" )
            ||  powername.equals( "Stealth" )
            ||  powername.equals( "Teamwork" )
            ...
            ||  powername.equals( "LOCKPICKING" )
            ||  powername.equals( "RIDING" )
            ||  powername.equals( "SLEIGHTOFHAND" )
            ||  powername.equals( "SLEATH" )
            ||  powername.equals( "TEAMWORK" )
            ...
            ||  powername.equals( "Forensic Medicine" )
            ||  powername.equals( "Inventor" )
            //lip reading needs to be called Lip Reading for for crappy CW/MC
            ||  powername.equals( "Lip Reading" )
            ||  powername.equals( "Mechanics" )
            ||  powername.equals( "Mimicry" )
            ||  powername.equals( "Paramedics" )
