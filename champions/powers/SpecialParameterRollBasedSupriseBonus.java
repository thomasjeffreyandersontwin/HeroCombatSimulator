 ...
 * @version
 */
public class SpecialParameterRollBasedSupriseBonus extends SpecialParameterAdapter implements ChampionsConstants {
    ...
    public SpecialParameterRollBasedSupriseBonus() {
    ...
    public boolean configure(Ability ability, ParameterList parameterList) {
        ...
        ability.add("Ability.ROLLBASEDSUPRISEBONUS", "TRUE", true);
    ...
    public void remove(Ability ability, int index) {
        ability.remove("Ability.ROLLBASEDSUPRISEBONUS");
