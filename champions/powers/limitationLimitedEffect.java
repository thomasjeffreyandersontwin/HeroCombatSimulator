 ...
 */
public class limitationLimitedEffect extends LimitationAdapter implements ChampionsConstants {
    ...
    public static String limitationName = "Limited Effect"; // The Name of the Limitation
    ...
    public limitationLimitedEffect() {
    }
