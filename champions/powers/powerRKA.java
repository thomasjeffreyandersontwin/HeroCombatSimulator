 ...
 */
public class powerRKA extends Power
implements ChampionsConstants {
    static final long serialVersionUID = 7766540941350027676L;
    ...
    private static String powerName = "Ranged Killing Attack"; // The Name of the Power
    ...
    private static String description = "Ranged Killing Attack";
    ...
    private static Object[][] patterns = {
        ...
        //HeroDesigner (02/15/04 added the same import patterns as HKA) kjr
...
//        }
        ...
        //       ability.addDiceInfo( "DamageDie", die, "Ranged Killing Attack Damage", STUN_ONLY, "Body Damage", null);
        //      ability.addDiceInfo( "StunDie", "1D6-1", "Ranged Killing Attack Stun Multiplier", STUN_ONLY, "Stun Multiplier", null);
 ...
 */
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( name != null && ( name.equals( "RKA" ) || name.startsWith("Killing Attack - Ranged" ) || name.equals( "Killing Attack (RKA)" )) ){
            return 10;
        }
        return 0;
    }
