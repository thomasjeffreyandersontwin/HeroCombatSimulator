 ...
 * @version
 */
public class SpecialParameterIsMartialManeuver extends SpecialParameterAdapter implements ChampionsConstants {
    ...
    public static String specialParameterName = "Martial Arts Maneuver"; // The Name of the SpecialParameter
    private static boolean unique = true; // Indicates whether multiple copies can be added to ability
    

    public SpecialParameterIsMartialManeuver() {
    ...
    public boolean configure(Ability ability, ParameterList parameterList) {
        ...
        ability.add("Ability.ISMARTIALMANEUVER", "TRUE", true);
    ...
    public void remove(Ability ability, int index) {
        ability.remove("Ability.ISMARTIALMANEUVER");
