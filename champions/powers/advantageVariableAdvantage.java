 ...
 */
public class advantageVariableAdvantage extends AdvantageAdapter implements ChampionsConstants {
    static final long serialVersionUID = -6399128353213512419L;
    ...
    static private Object[][] parameterArray = {
        {"Level","Advantage.VARIABLELEVEL", Double.class, new Double(0.25), "Level", DOUBLE_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "MINIMUM", new Double(0.25)}
    };
    
    // Advantage Definition Variables
    public static String advantageName = "Variable Advantage"; // The Name of the Advantage
   ...
   // Import Patterns Definitions
    ...
    public advantageVariableAdvantage() {
    }
    ...
    public double calculateMultiplier() {
        ...
        double level = (Double)pl.getParameterValue("Level");
        
        if ( ability.isVariationInstance() ) {
            // Variations get variable advantages, up to Level, free...
            return level;
        }
        else {
            return level * 2;
    ...
    public String getConfigSummary() {
        ...
        return "Variable Advantage(" + ChampionsUtilities.toStringWithFractions(level) +")";
    }
