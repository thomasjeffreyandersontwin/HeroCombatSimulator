 ...
 */
public class advantagePersonalImmunity extends AdvantageAdapter implements ChampionsConstants {
  ...
  //  {"MaxShots","Ability.MAXSHOTS", Integer.class, new Integer(5), "Max Shots", INTEGER_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "MINIMUM", new Integer(2)}
    ...
    public static String advantageName = "Personal Immunity"; // The Name of the Advantage
   ...
   // Import Patterns Definitions
    private static Object[][] patterns = {
        { "Personal Immunity.*", null}
    };
    
    /** Creates new advCombatModifier */
    public advantagePersonalImmunity() {
    }
