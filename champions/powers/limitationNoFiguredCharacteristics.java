 ...
 */
public class limitationNoFiguredCharacteristics extends LimitationAdapter implements ChampionsConstants {
    ...
    public static String limitationName = "No Figured Characteristics"; // The Name of the Limitation
    private static String limitationDescription = "Doesn't Affect Figured Characteristics"; // The Description of the Limitation
    private static boolean unique = true; // Indicates whether multiple copies can be added to ability

    // Import Patterns Definitions
    private static Object[][] patterns = {
        { "Doesn't Affect Figured.*", null}
    };
    
    /** Creates new advCombatModifier */
    public limitationNoFiguredCharacteristics() {
    }
    ...
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        //String noknockback = (String)parameterList.getParameterValue("NoKnockback");
        ...
        ability.add("Power.AFFECTSFIGURED", "FALSE",true);
    ...
    public String getConfigSummary() {
        return "No Figured Characteristics";
    }
  ...
  /*  public int identifyLimitation(AbilityImport ai,int line) {
        ...
        if ( possibleLimitation != null && possibleLimitation.indexOf( "Doesn't Affect Figured:" ) != -1 ) {
            return 10;
        }
