 ...
 */
public class limitationDoesNotProvideMentalAwareness extends LimitationAdapter implements ChampionsConstants {
...
//        { "LinkedToAbility","LinkedToAbility*.ABILITY", Ability.class, null, "Abilities aided to", LIST_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED}
    ...
    public static String limitationName = "Does Not Provide Mental Awareness"; // The Name of the Limitation
    private static boolean unique = true; // Indicates whether multiple copies can be added to ability
    
    // Import Patterns Definitions
    private static Object[][] patterns = {
        { "Does Not Provide Mental Awareness.*",null}
    };
    
    /** Creates new advCombatModifier */
    public limitationDoesNotProvideMentalAwareness() {
    }
    
    public String getName() {
        return "Does Not Provide Mental Awareness";
    }
    ...
    public int identifyLimitation(AbilityImport ai,int line) {
        ...
        if ( possibleLimitation != null && possibleLimitation.indexOf( "Does Not Provide Mental Awareness" ) != -1 ) {
            return 10;
        }
        else return 0;
