 ...
 */
public class advantageGenericAdvantage extends AdvantageAdapter
implements ChampionsConstants {
    ...
    static private Object[][] parameterArray = {
        {"Description","Advantage#.DESCRIPTION", String.class, "Generic Advantage", "Description", STRING_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "FIELDWIDTH", new Integer(200)},
        {"Multiplier","Advantage#.MULTIPLIER", Double.class, 0.0, "Multiplier", DOUBLE_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
        {"AffectsDC", "Advantage#.AFFECTSDC", Boolean.class, new Boolean(false), "Affects Damage Class Calculations", BOOLEAN_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED}
    };
    
    // Advantage Definition Variables
    public static String advantageName = "Generic Advantage"; // The Name of the Advantage
    ...
    public advantageGenericAdvantage() {
    }
    ...
    public String getConfigSummary() {
        ...
        if ( affectsDCparam ) s = s + ", affects DC";
        s = s + " Generic Advantage)";
        return (s);
