 ...
 */
public class limitationMandatoryEffect extends LimitationAdapter implements ChampionsConstants {
    
    static final long serialVersionUID = -6870520616782472305L;
    
    static private String[] typeOptions =  { "0", "-\u00BC", "-\u00BD", "-\u00BE", "-1", "-1\u00BC", "-1\u00BD", "-1\u00BE", "-2", "-2\u00BC", "-2\u00BD", "-2\u00BE", "-3" };
    ...
    static private Object[][] parameterArray = {
        {"Level","MandatoryEffect.LEVEL", String.class, "None", "Mandatory Level", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", levelOptions},
        {"Multiplier","Limitation#.MULTIPLIER", String.class, "0", "Attacker Must Achieve A Certain Effect", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", typeOptions}
        
    };
    
    // Limitation Definition Variables
    public static String limitationName = "Mandatory Effect"; // The Name of the Limitation
    private static boolean unique = true; // Indicates whether multiple copies can be added to ability
    
    // Import Patterns Definitions
    private static Object[][] patterns = {
        { "Mandatory Effect.*",null}
    };
    
    /** Creates new advCombatModifier */
    public limitationMandatoryEffect() {
    }
    
    public String getName() {
        return "Mandatory Effect";
    }
    ...
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        if (level.equals("TEN")) {
            parameterList.setParameterValue("Level", "STAT + 10");
        }
        else if (level.equals("TWENTY")) {
            parameterList.setParameterValue("Level", "STAT + 20"); 
        }
        else if (level.equals("THIRTY")) {
            parameterList.setParameterValue("Level", "STAT + 30"); 
        }
        else if (level.equals("THRITY")) {
            parameterList.setParameterValue("Level", "STAT + 30"); 
        }
    ...
    public double calculateMultiplier() {
        ...
        int j;
        for (j = 0;j< levelOptions.length;j++) {
            if ( level.equals(levelOptions[j])) break;
            costj = costj -0.25;
        }
    ...
    public int identifyLimitation(AbilityImport ai,int line) {
        ...
        if ( possibleLimitation != null && possibleLimitation.indexOf( "Mandatory Effect" ) != -1 ) {
            return 10;
        }
        else return 0;
