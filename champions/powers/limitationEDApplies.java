 ...
 */
public class limitationEDApplies extends LimitationAdapter implements ChampionsConstants {
    ...
    public static String limitationName = "ED Applies"; // The Name of the Limitation
    private static String limitationDescription = "ED Applies"; // The Description of the Limitation
    ...
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        //ability.add("Ability.EDAPPLIES", "TRUE", true);
    ...
    public void prepower(BattleEvent be, Effect effect, Target target, int targetReferenceNumber, String targetGroup, String hitLocationForDamage, boolean finalTarget) throws BattleEventException {
        ...
        for(int i = 0; i < count; i++) {
            effect.addSubeffectDefenseType(i,"ED");
        }
    }
    ...
    public void removeLimitation() {
        ability.remove("Ability.EDAPPLIES");
    }
}