 ...
 */
public class skillDefenseManeuver extends Skill implements ChampionsConstants {
    static final long serialVersionUID =5295828683348707403L;
    
    /** Next 1 line added by PR*/
    static public String[] ptypeOptions = {"INSTANT","CONSTANT"};
    ...
    private static String powerName = "Defense Maneuver"; // The Name of the Power
    ...
    private static Object[][] patterns = {
        { "Defense Maneuver (.*)", new Object[] {"Level", String.class}},
        //{ "(.*)", new Object[] {"Level", String.class}},        
    ...
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        if (level != null && level.equals("IV") ) {
            ability.setPType("CONSTANT", true);
            //ability.add("Ability.TIME", "INSTANT", true);
            ability.setActivationTime("INSTANT", true);
            //ability.add("Ability.NORMALLYON", "TRUE", true);
            ability.setNormallyOn(true);
        }
        else {
            ability.setPType("INSTANT", true);
            //ability.add("Ability.TIME", "HALFMOVE", true);
            ability.setActivationTime("HALFMOVE", true);
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && ( power.equals( "DEFENSEMANEUVER" ) || power.equals( "DEFENSE_MANEUVER") )){
            return 10;
        }
        return 0;
    }
    ...
    public void triggerPower(BattleEvent be, Ability ability, DetailList effectList, Target target, int referenceNumber, String targetGroup) throws BattleEventException {
        Effect effect = new effectDefenseManeuver(ability );
