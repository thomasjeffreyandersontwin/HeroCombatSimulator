 ...
 */
public class disadvantagePsychologicalLimitation extends Disadvantage implements ChampionsConstants {
    ...
    static private Integer[] situationCostArray = new Integer[] { new Integer(5), new Integer(10),new Integer(15)};
    
    private static final String[] intensityOptions =  {
        "Moderate", "Strong", "Total"
    };
    static private Integer[] intensityCostArray = new Integer[] { new Integer(0), new Integer(5), new Integer(10) };
    
    static private Object[][] parameterArray = {
        {"Situation","Disadvantage.SITUATION", String.class, "Uncommon", "Situation", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", situationOptions},
        {"Intensity","Disadvantage.INTENSITY", String.class, "Moderate", "Intensity", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", intensityOptions},
    };
    ...
    static private Object[][] costArray = {
        ...
        { "Intensity", COMBO_COST, STATIC_RECONFIG, ZERO_RECONFIG,  intensityCostArray, intensityOptions },
    };
    
    // Power Definition Variables
    private static String powerName = "Psychological Limitation"; // The Name of the Power
    ...
    private static Object[][] patterns = {
        ...
        { "INTENSITY: (.*)", new Object[] {"Intensity", String.class}},
    };
    
    /** Creates new powerHandToHandAttack */
    public disadvantagePsychologicalLimitation()  {
    }
    ...
    public String getConfigSummary(Ability ability, int not_used) {
        return "Psycholgoical Limitation";
    }
...
//    }
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && power.equals( "PSYCHOLOGICALLIMITATION" )){
            return 10;
        }
        return 0;
    }
