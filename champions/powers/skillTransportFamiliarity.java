 ...
 */
public class skillTransportFamiliarity extends Skill implements ChampionsConstants, BackgroundSkill {
    ...
    private static String powerName = "Transport Familiarity"; // The Name of the Power
    ...
    public skillTransportFamiliarity()  {
    }
