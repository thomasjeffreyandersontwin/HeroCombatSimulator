 ...
 */
public class powerUnknockdown extends Power
implements ChampionsConstants {
    ...
    private static String powerName = "Unknockdown"; // The Name of the Power
  ...
  */
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        ability.setPowerDescription( "Unknockdown");
    ...
    public void triggerPower(BattleEvent be, Ability ability,DetailList effectList, Target target, int refNumber, String targetGroup) throws BattleEventException {
        if ( target.hasEffect("Knocked Down")) {
            target.removeEffect( be, "Knocked Down" );
        }
    }
    ...
    public boolean isEnabled(Ability ability, Target source) {
        ...
        if ( Battle.currentBattle != null ) {
            ...
            if ( time.isTurnEnd() ) return false;
            if ( Battle.currentBattle.getActiveTarget().hasEffect("Knocked Down") != true ) {
                ability.setEnableMessage("Character isn't knocked down");
                return false;
            }
        }
        return true;
