 ...
 */
public class disadvantageHunted extends Disadvantage implements ChampionsConstants {
    static final long serialVersionUID =5295848683348706403L;
    
    private static final String[] levels =  {"8", "11", "14"};
    
    static private Integer[] levelsCostArray = new Integer[] { new Integer(0), new Integer(5), new Integer(10) };
    
    static public String[] capabilitiesOptions = {"Less Powerful","As Powerful","More Powerful"};
    
    static private Integer[] capabilitiesCostArray = new Integer[] { new Integer(5), new Integer(10), new Integer(15)};
    
    static public String[] motivationOptions = {"Watched","Mildly Punish","Capture","Harshly Punish"};
    
    static private Integer[] motivationCostArray = new Integer[] { new Integer(-10), new Integer(-5), new Integer(-0), new Integer(-0)};

    
    static private Object[][] parameterArray = {
        {"Capabilities","Disadvantage.CAPABILITIES", String.class, "Less Powerful", "Capabilities Of Hunter", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", capabilitiesOptions},
        {"ActivationRoll","Disadvantage.LEVEL", String.class, "8", "Activation Roll", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", levels},
        {"Motivation","Disadvantage.MOTIVATION", String.class, "Harshly Punish", "Motivation Of Hunter", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", motivationOptions},
        {"ExtensiveNonCombatInfluence","Disadvantage.EXTENSIVENONCOMBATINFLUENCE", Boolean.class, new Boolean(false),"Extensive Non-Combat Influence", BOOLEAN_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
        {"LimitedGeographicalArea","Disadvantage.LIMITEDGEOGRAPHICALAREA", Boolean.class, new Boolean(false), "Limited Geographical Area", BOOLEAN_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
        {"PCHasAPublicIDOrIsOtherwiseVeryEasyToFind","Disadvantage.PCHASAPUBLICIDORISOTHERWISEVERYEASYTOFIND", Boolean.class, new Boolean(false), "PC Has A Public ID Or Is Otherwise Very Easy To Find", BOOLEAN_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
    };
    
    // Cost Array - See Power.getCostArray()
    static private Object[][] costArray = {
        { "Capabilities", COMBO_COST, STATIC_RECONFIG, ZERO_RECONFIG, capabilitiesCostArray, capabilitiesOptions },
        { "ActivationRoll", COMBO_COST, STATIC_RECONFIG, ZERO_RECONFIG, levelsCostArray, levels },
        { "Motivation", COMBO_COST, STATIC_RECONFIG, ZERO_RECONFIG, motivationCostArray, motivationOptions },
        { "ExtensiveNonCombatInfluence", BOOLEAN_COST, DYNAMIC_RECONFIG, ZERO_RECONFIG, new Integer(5)},
        { "LimitedGeographicalArea", BOOLEAN_COST, DYNAMIC_RECONFIG, ZERO_RECONFIG, new Integer(-5)},
        { "PCHasAPublicIDOrIsOtherwiseVeryEasyToFind", BOOLEAN_COST, DYNAMIC_RECONFIG, ZERO_RECONFIG, new Integer(5)},
    };
    // Power Definition Variables
    private static String powerName = "Hunted"; // The Name of the Power
    ...
    private static Object[][] patterns = {
        ...
        { "CAPABILITIES: (.*)", new Object[] {"Capabilities", String.class}},
        { "MOTIVATION: (.*)", new Object[] {"Motivation", String.class}},
        { "(PUBLIC).*", new Object[] {"PCHasAPublicIDOrIsOtherwiseVeryEasyToFind", Boolean.class}},
        { "(LIMITED).*", new Object[] {"LimitedGeographicalArea", Boolean.class}},
        { "(NCI).*", new Object[] {"ExtensiveNonCombatInfluence", Boolean.class}},
        //{ "Non-Combat Multiplier: ([0-9]*),.*", new Object[] { "NoncombatX", Integer.class}},
    };
    
    /** Creates new powerHandToHandAttack */
    public disadvantageHunted()  {
    }
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && power.equals( "HUNTED" )){
            return 10;
        }
        return 0;
    }
