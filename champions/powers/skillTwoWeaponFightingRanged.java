 ...
 */
public class skillTwoWeaponFightingRanged extends Skill implements ChampionsConstants {
    ...
    private static String powerName = "Two-Weapon Fighting (Ranged)"; // The Name of the Power
    ...
    public skillTwoWeaponFightingRanged()  {
    }
    ...
    public void triggerPower(BattleEvent be, Ability ability, DetailList effectList, Target target, int referenceNumber, String targetGroup) throws BattleEventException {
        ...
        Effect effect =  new effectTwoWeaponFightingRanged(ability.getName());
