 ...
 */
public class limitationPDApplies extends LimitationAdapter implements ChampionsConstants {
    ...
    public static String limitationName = "PD Applies"; // The Name of the Limitation
    private static String limitationDescription = "PD Applies"; // The Description of the Limitation
    ...
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        //ability.add("Ability.PDAPPLIES", "TRUE", true);
        //ability.setLimitationPriority(index,3);
    ...
    public void prepower(BattleEvent be, Effect effect, Target target, int targetReferenceNumber, String targetGroup, String hitLocationForDamage, boolean finalTarget) throws BattleEventException {
        ...
        //effect.addIncreaseSubeffect("PD", "PD", target.getAdjustedStat("MD"), ADJUSTED_STAT);
        int count = effect.getSubeffectCount();
        for(int i = 0; i < count; i++) {
            effect.addSubeffectDefenseType(i,"PD");
        }
    }
    ...
    public void removeLimitation() {
        ability.remove("Ability.PDAPPLIES");
    }
}