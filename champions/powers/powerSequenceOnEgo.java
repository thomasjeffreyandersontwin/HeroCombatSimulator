 ...
 */
public class powerSequenceOnEgo extends Power implements ChampionsConstants {
    ...
    private static String powerName = "Sequence On Ego"; // The Name of the Power
  ...
  */
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        ability.setPowerDescription("Switch Sequence On Ego");
    ...
    public void triggerPower(BattleEvent be, Ability ability,DetailList effectList, Target target, int refNumber, String targetGroup) throws BattleEventException {
        target.setSequenceOnEgo(! target.isSequenceOnEgo() ) ;
    }
