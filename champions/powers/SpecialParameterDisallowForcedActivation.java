 ...
 * @version
 */
public class SpecialParameterDisallowForcedActivation extends SpecialParameterAdapter implements ChampionsConstants {
    ...
    private static String specialParameterName = "Disallow Forced Activation"; // The Name of the SpecialParameter
    private static boolean unique = true; // Indicates whether multiple copies can be added to ability
    

    public SpecialParameterDisallowForcedActivation() {
    ...
    public String getConfigSummary(Ability ability, int index) {
        ...
        return "Disallow Forced Activation";
    }
