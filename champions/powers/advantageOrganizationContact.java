 ...
 */
public class advantageOrganizationContact extends AdvantageAdapter implements ChampionsConstants {
  ...
  //  {"MaxShots","Ability.MAXSHOTS", Integer.class, new Integer(5), "Max Shots", INTEGER_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "MINIMUM", new Integer(2)}
    ...
    public static String advantageName = "Organization Contact"; // The Name of the Advantage
   ...
   // Import Patterns Definitions
    ...
    public advantageOrganizationContact() {
    }
