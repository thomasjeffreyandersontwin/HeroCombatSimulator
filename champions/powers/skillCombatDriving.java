 ...
 */
public class skillCombatDriving extends Skill implements ChampionsConstants {
    ...
    private static String powerName = "Combat Driving"; // The Name of the Power
...
//    }
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && power.equals( "COMBAT_DRIVING" )){
            return 10;
        }
        return 0;
    }    
