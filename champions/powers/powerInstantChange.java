 ...
 */
public class powerInstantChange extends Power implements ChampionsConstants {
    static final long serialVersionUID =5295848681348707403L;
    
    static private String[] setArray = {
        "One Set",
        "Any Set",
    };

    static private Integer[] setCostArray = new Integer[] { new Integer(5), new Integer(10) };

    
    static private Object[][] parameterArray = {
        {"Clothes","Power.CLOTHES", String.class, "One Set", "Sets of Clothes", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", setArray },
    };

        // Cost Array - See Power.getCostArray()
    static private Object[][] costArray = {
        { "Clothes", COMBO_COST, STATIC_RECONFIG, ZERO_RECONFIG, setCostArray, setArray }
    };
    ...
    private static String powerName = "Instant Change"; // The Name of the Power
    ...
    private static String description = "Dude, its instant change, ok?";
    
    // Import Patterns Definitions
    private static Object[][] patterns = {
        { "Instant Change", null },
        { "Clothes: (.*), .*", new Object[] { "Clothes", String.class} },
        
    };
    
    /** Creates new powerHandToHandAttack */
    public powerInstantChange()  {
    }
...
/*    public int calculateCPCost(Ability ability) {
        ...
        String clothes = (String)parameterList.getParameterValue("Clothes");
      
        
        if (clothes.equals("Any Set") ) return 10;
        else return 5;
