...
public class powerMartialDC extends Power
implements ChampionsConstants {
    static final long serialVersionUID =5295848453348707403L;
    ...
    private static String powerName = "Martial Damage Classes"; // The Name of the Power
...
/* Returns an array which can be used to create the parameterList.
  ...
  */
    ...
    public String getConfigSummary(Ability ability, int not_used) {
        ...
        return "Martial Damage Classes (" + ChampionsUtilities.toSignedString( level ) + ")";
    }
    ...
    public void triggerPower(BattleEvent be, Ability ability,DetailList effectList, Target target, int refNumber, String targetGroup) throws BattleEventException {
        Effect effect = new effectMartialDC(ability.getName(),ability);
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && power.equals( "DC for Martial Attacks" ) ) {
            return 10;
        }
        else if ( power != null && power.equals( "HTH Damage Class" ) ) {
            return 10;
        }
        else if ( power != null && power.equals( "EXTRADC" ) ) {
            return 10;
        }
        return 0;
    }
