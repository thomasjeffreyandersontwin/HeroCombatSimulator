 ...
 */
public class limitationCannotBeUsedThroughMindLink extends LimitationAdapter implements ChampionsConstants {
...
//        { "LinkedToAbility","LinkedToAbility*.ABILITY", Ability.class, null, "Abilities aided to", LIST_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED}
    ...
    public static String limitationName = "Cannot Be Used Through Mind Link"; // The Name of the Limitation
    private static boolean unique = true; // Indicates whether multiple copies can be added to ability
    
    // Import Patterns Definitions
    private static Object[][] patterns = {
        { "Cannot Be Used Through Mind Link.*",null}
    };
    
    /** Creates new advCombatModifier */
    public limitationCannotBeUsedThroughMindLink() {
    }
    
    public String getName() {
        return "Cannot Be Used Through Mind Link";
    }
    ...
    public int identifyLimitation(AbilityImport ai,int line) {
        ...
        if ( possibleLimitation != null && possibleLimitation.indexOf( "Cannot Be Used Through Mind Link" ) != -1 ) {
            return 10;
        }
        else return 0;
