 ...
 * @version
 */
public class SpecialParameterDCVModifier extends SpecialParameterAdapter implements ChampionsConstants {
    ...
    static private Object[][] parameterArray = {
        {"DCVModifier","SpecialParameter#.DCVMODIFIER", Integer.class, new Integer(0), "DCV Modifier", INTEGER_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED}
    };
    
    // SpecialParameter Definition Variables
    private static String specialParameterName = "DCV Modifier"; // The Name of the SpecialParameter
    private static boolean unique = true; // Indicates whether multiple copies can be added to ability
    

    public SpecialParameterDCVModifier() {
    ...
    public boolean configure(Ability ability, ParameterList parameterList) {
        ...
        Integer modifier = (Integer)parameterList.getParameterValue("DCVModifier");
        ...
        //ability.add("Ability.DCVBONUS", modifier, true);
        ability.setDCVModifier(modifier);
    ...
    public void remove(Ability ability, int index) {
        //ability.remove("Ability.DCVBONUS");
        ability.setDCVModifier(0);
    }
    ...
    public String getConfigSummary(Ability ability, int index) {
        ...
        return "DCV " + ChampionsUtilities.toSignedString(modifier);
    }
