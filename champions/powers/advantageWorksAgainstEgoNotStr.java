 ...
 */
public class advantageWorksAgainstEgoNotStr extends AdvantageAdapter implements ChampionsConstants {
    ...
    public static String advantageName = "Works against EGO, not STR"; // The Name of the Advantage
    ...
    public advantageWorksAgainstEgoNotStr() {
    }
    ...
    public String getConfigSummary() {       
        return "Works against EGO, not STR";
    }
