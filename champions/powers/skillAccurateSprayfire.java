 ...
 */
public class skillAccurateSprayfire extends Skill implements ChampionsConstants {
    ...
    private static String powerName = "Accurate Sprayfire"; // The Name of the Power
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && power.equals( "ACCURATESPRAYFIRE" )){
            return 10;
        }
        return 0;
    }
