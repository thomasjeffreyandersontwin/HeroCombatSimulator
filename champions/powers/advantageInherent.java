 ...
 */
public class advantageInherent extends AdvantageAdapter implements ChampionsConstants {
    ...
    public static String advantageName = "Inherent"; // The Name of the Advantage
