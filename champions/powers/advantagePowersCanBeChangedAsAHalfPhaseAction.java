 ...
 */
public class advantagePowersCanBeChangedAsAHalfPhaseAction extends AdvantageAdapter implements ChampionsConstants {
    ...
    public static String advantageName = "Powers can be changed as a half phase action"; // The Name of the Advantage
    ...
    public advantagePowersCanBeChangedAsAHalfPhaseAction() {
    }
