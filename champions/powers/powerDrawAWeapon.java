 ...
 */
public class powerDrawAWeapon extends Power implements ChampionsConstants {
    static final long serialVersionUID = -8559515533022444649L;
    
    private static Object[][] parameterArray = {
    };
    
    // Power Definition Variables
    private static String powerName = "Draw A Weapon"; // The Name of the Power
