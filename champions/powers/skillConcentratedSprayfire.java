 ...
 */
public class skillConcentratedSprayfire extends Skill implements ChampionsConstants {
    ...
    private static String powerName = "Concentrated Sprayfire"; // The Name of the Power
    ...
    public skillConcentratedSprayfire()  {
    }
    ...
    public String getConfigSummary(Ability ability, int not_used) {
        ...
        String s = "Concentrated Sprayfire";
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && power.equals( "CONCENTRATEDSPRAYFIRE" )){
            return 10;
        }
        return 0;
    }
