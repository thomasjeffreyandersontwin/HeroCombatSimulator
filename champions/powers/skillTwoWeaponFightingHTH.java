 ...
 */
public class skillTwoWeaponFightingHTH extends Skill implements ChampionsConstants {
    static final long serialVersionUID =5295828683342707403L;
    ...
    private static String powerName = "Two-Weapon Fighting (HTH)"; // The Name of the Power
    ...
    public skillTwoWeaponFightingHTH()  {
    }
    ...
    public void triggerPower(BattleEvent be, Ability ability, DetailList effectList, Target target, int referenceNumber, String targetGroup) throws BattleEventException {
        ...
        Effect effect =  new effectTwoWeaponFightingHTH(ability.getName());
