 ...
 */
public class PerkComputerLink extends Talent
        implements ChampionsConstants {
    static final long serialVersionUID = 7766760931220127676L;
    
    static private Object[][] parameterArray = {
        {"Levels","Power.LEVELS", Integer.class, new Integer(0), "Points", INTEGER_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
        
    };
    
    // Power Definition Variables
    private static String powerName = "Computer Link"; // The Name of the Power
    ...
    static private Object[][] costArray = {
        //{ "Levels", BASE_COST, STATIC_RECONFIG, ZERO_RECONFIG, new Integer(5) },
