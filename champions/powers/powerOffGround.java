 ...
 */
public class powerOffGround extends Power implements ChampionsConstants{
    ...
    private static String powerName = "Off Ground"; // The Name of the Power
   ...
   private static boolean dynamic = true;
    private static String description = "Dude, its a Off Ground, ok?";
  ...
  */
    ...
    public void triggerPower(BattleEvent be, Ability ability, DetailList effectList, Target target, int refNumber, String TargetGroup) throws BattleEventException {
        //System.out.println("triggerPower gets run now!");
        Effect effect =  new effectOffGround(ability);
