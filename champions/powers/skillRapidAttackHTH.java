 ...
 */
public class skillRapidAttackHTH extends Skill implements ChampionsConstants {
    ...
    private static String powerName = "Rapid Attack (HTH)"; // The Name of the Power
