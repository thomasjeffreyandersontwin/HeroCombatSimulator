 ...
 */
public class limitationIncreasedEndurance extends LimitationAdapter implements ChampionsConstants {
    ...
    // "Limitation#" and only the second half is kept.
    static private Object[][] parameterArray = {
        {"Level","IncreasedEndurance.LEVEL", Integer.class, new Integer(2), "Level", INTEGER_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
    };
    
    // Limitation Definition Variables
    public static String limitationName = "Increased END"; // The Name of the Limitation
    private static boolean affectsDC = false; // Indicates the Limitation affects the cost of damage classes
    private static String limitationDescription = "Increased END"; // The Description of the Limitation
    private static boolean unique = true; // Indicates whether multiple copies can be added to ability
    
    // Import Patterns Definitions
    private static Object[][] patterns = {
        { "Increased END: .([0-9]*).*", new Object[] {"Level", Integer.class}},
        { "Increased Endurance \\(.([0-9]*)\\).*", new Object[] {"Level", Integer.class}}
    };
    
    /** Creates new advCombatModifier */
    public limitationIncreasedEndurance() {
    }
    ...
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        // LimitationAreaEffect has nothing to validate.
        ...
        ability.setENDMultiplier(level.intValue(), this );
    ...
    public double calculateMultiplier() {
        ...
        for (int index2 = 1;index2 < level.intValue();index2++) {
            cost += -.50;
            if (index2 == 9) cost -= -.50;
            //if (index2 >= 10) return cost;
    ...
    public String getConfigSummary() {
        ...
        return level.intValue() + "x Increased END";
    }
    ...
    public int identifyLimitation(AbilityImport ai,int line) {
        ...
        if ( possibleLimitation != null && possibleLimitation.indexOf( "Increased END:" ) != -1 ) {
            return 10;
        }
        if ( possibleLimitation != null && possibleLimitation.indexOf( "Increased Endurance" ) != -1 ) {
            return 10;
        }
