 ...
 */
public class advantageRanged extends AdvantageAdapter implements ChampionsConstants {
    static final long serialVersionUID = -6399128353213532419L;
    
    static private String[] typeOptions = { "Ranged", "Limited Range", "Range Based on STR" };
  ...
  //  {"MaxShots","Ability.MAXSHOTS", Integer.class, new Integer(5), "Max Shots", INTEGER_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "MINIMUM", new Integer(2)}
        {"RangeType","Advantage.RANGETYPE", String.class, "Ranged", "Type", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", typeOptions},
    };
    
    // Advantage Definition Variables
    public static String advantageName = "Ranged"; // The Name of the Advantage
   ...
   // Import Patterns Definitions
    ...
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        String rangetype = (String)parameterList.getParameterValue("RangeType");
        ...
        if (rangetype.equals("RANGED")) {
            parameterList.setParameterValue("RangeType", "Ranged");
        }
        else if (rangetype.equals("LIMITEDRANGE")) {
            parameterList.setParameterValue("RangeType", "Limited Range");
        }
        else if (rangetype.equals("RANGEBASEDONSTR")) {
            parameterList.setParameterValue("RangeType", "Range Based on STR");
        }
    ...
    public double calculateMultiplier() {
        ...
        else if (rangetype.equals("Limited Range")) {
            return 0.25;
        }
        else if (rangetype.equals("Range Based on STR")) {
            return 0.25;
        }
    ...
    public int identifyLimitation(AbilityImport ai,int line) {
        ...
        if ( possibleLimitation != null && possibleLimitation.indexOf( "Ranged" ) != -1 ) {
            return 10;
