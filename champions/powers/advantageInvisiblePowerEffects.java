 ...
 */
public class advantageInvisiblePowerEffects extends AdvantageAdapter implements ChampionsConstants {
    ...
    static private Object[][] parameterArray = {
        {"SenseGroup","SenseGroup*.SENSEGROUP", String.class, "All Sight", "Sense Group", LIST_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", senseGroupArray},
    };
    
    
    // Advantage Definition Variables
    public static String advantageName = "Invisible Power Effect"; // The Name of the Advantage
    ...
    private static Object[][] patterns = {
        { "Invisible \\((.*)\\).*", new Object[] { "SenseGroup", String.class} }
    };
    
    /** Creates new advCombatModifier */
    public advantageInvisiblePowerEffects() {
    }
    ...
    public double calculateMultiplier() {
        Integer sensegroup = ability.getIntegerValue("SenseGroup.INDEXSIZE" );
        double total = 0;
        ...
        if (sensegroup == null) {
            ...
            total = 0.5 + ( (sensegroup.intValue() - 1) *.25);
            if (total > 1) {
                return 1;
            }
            else return total;
        ...
        if ( possibleAdvantage != null && possibleAdvantage.indexOf( "Invisible" ) != -1 ) {
            return 10;
        }
