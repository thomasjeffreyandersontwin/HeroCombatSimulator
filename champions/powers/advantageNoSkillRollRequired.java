 ...
 */
public class advantageNoSkillRollRequired extends AdvantageAdapter implements ChampionsConstants {
    ...
    public static String advantageName = "No Skill Roll Required"; // The Name of the Advantage
    ...
    public advantageNoSkillRollRequired() {
    }
    ...
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        if ( ability.hasAdvantage(advantageCosmic.advantageName)) {
            return false;
        }
