 ...
 */
public class skillBreakfall extends Skill implements ChampionsConstants {
    ...
    private static String powerName = "Breakfall"; // The Name of the Power
 ...
 */
    ...
    //
    //        Effect effect =  new effectCombatModifier(ability.getName() +" modifier",difference.intValue(),0);
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && power.equals( "BREAKFALL" )){
            return 10;
        }
        return 0;
    }
