 ...
 */
public class limitationAlwaysOn extends LimitationAdapter implements ChampionsConstants {
    
    static final long serialVersionUID = -6871240616782472305L;
...
//        { "LinkedToAbility","LinkedToAbility*.ABILITY", Ability.class, null, "Abilities aided to", LIST_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED}
    ...
    public static String limitationName = "Always On"; // The Name of the Limitation
