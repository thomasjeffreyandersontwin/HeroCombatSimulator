 ...
 */
public class powerFlashDefense extends Power 
implements ChampionsConstants{
    static final long serialVersionUID =5295848583348707203L;

    static private Object[][] parameterArray = {
        {"Level","Power.LEVEL", Integer.class, new Integer(5), "Flash Defense Level", INTEGER_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
        {"Senses","Sense*.SENSE", Sense.class, null, "Senses", LIST_PARAMETER, VISIBLE, ENABLED, REQUIRED}
    };

    // Power Definition Variables
    private static String powerName = "Flash Defense"; // The Name of the Power
   ...
   private static boolean dynamic = true;
    private static String description = "Dude, it's a Flash Defense, ok?";
    
    // Import Patterns Definitions
    private static Object[][] patterns = {
        //{ ".*\\((.*), ([0-9]*) pts\\)", new Object[] { "Sense", String.class, "Level", Integer.class }},
    };
    ...
    static private Object[][] costArray = {
        { "Level", GEOMETRIC_COST, DYNAMIC_RECONFIG, ALL_RECONFIG, new Integer(1), new Integer(1), new Integer(0), new Integer(0) }
        
    };
    
    public powerFlashDefense()  {
    }
  ...
  */
    ...
    public void triggerPower(BattleEvent be, Ability ability,DetailList effectList, Target target, int refNumber, String targetGroup) throws BattleEventException {
        ...
        Effect effect = new effectFlashDefense( ability.getName(), ability);
  ...
  /*  public int calculateCPCost(Ability ability) {
    ...
    public String getConfigSummary(Ability ability, int not_used) {
        ...
        String senses = getSensesString(ability);

        return "Flash Defense (" + senses + "," + level.toString() + ")";
    }
    
    public static String getSensesString(Ability flashDefenseAbility) {
        ParameterList pl = flashDefenseAbility.getPowerParameterList();
        List<Sense> configuredSenses = pl.getIndexedParameterValues("Senses");
        
        StringBuilder sb = new StringBuilder();
        
        int count = configuredSenses.size();
        ...
        for(int i = 0; i < count; i++ ) {
            ...
            sb.append( configuredSenses.get(i).getSenseName() );
        }
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && ( power.equals( "FLASHDEFENSE" ) || power.equals( "Flash Defense" ) )){
            return 10;
        }
        return 0;
    }
