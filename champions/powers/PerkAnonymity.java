 ...
 */
public class PerkAnonymity extends Talent
        implements ChampionsConstants {
    static final long serialVersionUID = 7766760931220027676L;
    
    static private Object[][] parameterArray = {
        //{"Hidden","Power.HIDDEN", Integer.class, new Integer(0), "Hidden Penalty", INTEGER_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
        
    };
    
    // Power Definition Variables
    private static String powerName = "Anonymity"; // The Name of the Power
