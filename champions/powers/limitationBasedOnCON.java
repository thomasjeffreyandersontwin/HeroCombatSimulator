 ...
 */
public class limitationBasedOnCON extends LimitationAdapter implements ChampionsConstants {
    
    static final long serialVersionUID = -6870520616782472305L;
    
    static private String[] typeOptions = new String[] { "PD","ED"};
...
//        { "LinkedToAbility","LinkedToAbility*.ABILITY", Ability.class, null, "Abilities aided to", LIST_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED}
    ...
    public static String limitationName = "based on CON"; // The Name of the Limitation
    ...
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        ability.add("Ability.CVTYPE", "OCV", true);
        ability.add("Power.DEFENSE", damagetype, true);
        ability.setHasRangeModifier(true);
    ...
    public int identifyLimitation(AbilityImport ai,int line) {
        ...
        if ( possibleLimitation != null && possibleLimitation.indexOf( "Based on CON" ) != -1 ) {
            return 10;
        }
        else return 0;
