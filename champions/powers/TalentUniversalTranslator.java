 ...
 */
public class TalentUniversalTranslator extends Skill implements ChampionsConstants {
    static final long serialVersionUID =5195828683348707403L;
    
    static public String[] statOptions = {"STR","CON","DEX","BODY","INT","EGO","PRE","COM","PD",
    "ED","SPD","REC","END","STUN"};
    
    static private String[] categoryOptions = {
        "None", "Documents", "Money", "Art Objects","Commercial Goods"
    };

    static private String[] subcategoryOptions = {
        "None", "Papers", "Identiy Cards", "Coins","Paper Money","Paintings",
        "Sculpture","Metalwork","Jewelry","Vehicle License Plates","Clothing","Credit Cards",
        "Machine/Vehicle Parts","Medicine"
    };
    
    static private Object[][] parameterArray = {
        {"BaseStat","Power.STAT", String.class, "INT", "Base Stat", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", statOptions},
        ...
        {"SubCategories","SubCategories*.SUBCATEGORY", String.class, null, "Subcategories", LIST_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", subcategoryOptions},
        {"CategoryTotal","Power.CATTOT", Integer.class, new Integer(0), "Total Categories", INTEGER_PARAMETER, HIDDEN, ENABLED, NOTREQUIRED},
        {"SubCategoryTotal","Power.SUBCATTOT", Integer.class, new Integer(0), "Total Subcategories", INTEGER_PARAMETER, HIDDEN, ENABLED, NOTREQUIRED},
    ...
    private static String powerName = "Forgery"; // The Name of the Power
    ...
    static private Object[][] costArray = {
        ...
        { "CategoryTotal", GEOMETRIC_COST, DYNAMIC_RECONFIG, ZERO_RECONFIG, new Integer(2), new Integer(1), new Integer(0), new Integer(0) },
        { "SubCategoryTotal", GEOMETRIC_COST, DYNAMIC_RECONFIG, ZERO_RECONFIG, new Integer(1), new Integer(1), new Integer(0), new Integer(0) },
    ...
    public TalentUniversalTranslator()  {
    }
    ...
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        Integer subcategorytotal = parameterList.getIndexedParameterSize("SubCategories" );
        ...
        if ( subcategorytotal !=null ) {
            parameterList.setParameterValue("SubCategoryTotal", new Integer( subcategorytotal.intValue() ) );
        }
 ...
 */
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && power.equals( "FORGERY" )){
            return 10;
        }
        return 0;
    }
...
//            if ( ChampionsMatcher.matches( "Additional Category: (.*), 2", line ) || ChampionsMatcher.matches( "Base Category: (.*)", line ) ) {
...
//            }
//            if ( ChampionsMatcher.matches( "Additional Category: (.*), 1", line ) || ChampionsMatcher.matches( "Base Subcategory: (.*)", line ) ) {
//                stringValue = ChampionsMatcher.getMatchedGroup(1);
//
//                int cindex = parameterList.createIndexed("SubCategories", "NAME", stringValue, false);
//                parameterList.addIndexed(cindex, "SubCategories", "LINE", new Integer(lineIndex), true, false );
//
//                ai.setLineUsed(lineIndex, this);
//            }
//        }
...
//        set = false;
//        
//        count = parameterList.getIndexedSize("SubCategories");
//        for ( int index2 = 0; index2 < count; index2++) {
//            Ability a = (Ability) parameterList.getIndexedValue(index2, "SubCategories", "SUBCATEGORY");
//            String name = parameterList.getIndexedStringValue(index2, "SubCategories", "NAME");
//            
//            if ( a == null && name != null ) {
//                    parameterList.addIndexed(index2, "SubCategories", "SUBCATEGORY", name, true, false);
//                    parameterList.removeIndexed(index2, "SubCategories", "NAME", false);
//                    parameterList.removeIndexed(index2, "SubCategories", "LINE", false);
//
//            }
//        }
//        
//        count = parameterList.getIndexedSize("SubCategories");
//        parameterList.setParameterOption("SubCategories", "SET", (count > 0) ? "TRUE" : "FALSE" );
//        
//        
//        return true;
//    }
