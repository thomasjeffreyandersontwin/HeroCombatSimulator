 ...
 */
public class advantageNND extends AdvantageAdapter 
implements ChampionsConstants {
    static final long serialVersionUID = -6399128335213532419L;
    
    static private String[] typeOptions = { "Standard", "Equally Common Defense", "Extraordinarily Common Defense" };
...
//        {"AttackType","NND.ATTACKTYPE", String.class, "", "Attack Type", STRING_PARAMETER, VISIBLE, ENABLED, REQUIRED},
        {"Defense","NND.DEFENSE", String.class, "", "Defense", STRING_PARAMETER, VISIBLE, ENABLED, REQUIRED},
        {"DefenseType","Advantage.DEFENSETYPE", String.class, "Standard", "Type", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", typeOptions},
    ...
    public static String advantageName = "No Normal Defense"; // The Name of the Advantage
    ...
    private static Object[][] patterns = {
        { "No Normal Defense:.*", null},
        { "NND Defense is.*: (.*)", new Object[] { "Defense", String.class}},
    ...
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
      ...
      //  String attackType = (String)parameterList.getParameterValue("AttackType");
        ...
        String defensetype = (String)parameterList.getParameterValue("DefenseType");
       
        // Check for the validity of the parameters that will be set.  If the parameters
        // Fail for any reason, return false from the method immediately, indicating a
        // failure to configure
        
        if (defensetype.equals("STANDARD")) {
            parameterList.setParameterValue("DefenseType", "Standard");
        }
        else if (defensetype.equals("EQUAL")) {
            parameterList.setParameterValue("DefenseType", "Equally Common Defense");
        }
        else if (defensetype.equals("EXTRAORDINARY")) {
            parameterList.setParameterValue("DefenseType", "Extraordinarily Common Defense");
        }
    ...
    public double calculateMultiplier() {
        ...
        else if (defensetype.equals("Equally Common Defense")) {
            return 0.50;
        }
        else if (defensetype.equals("Extraordinarily Common Defense")) {
            return 0.50;
        }
        return 1;
    }
    ...
    public String getConfigSummary() {
       ...
       // String attackType = (String)parameterList.getParameterValue("AttackType");
        ...
        String dclause = "";
        if ( defense != null && defense.equals("") == false ) {
            dclause = " (" + defense + ")";
        }
        return "NND" + dclause;
