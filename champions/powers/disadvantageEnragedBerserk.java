 ...
 */
public class disadvantageEnragedBerserk extends Disadvantage implements ChampionsConstants {
    ...
    private static final String[] recoverylevels =  {
        "14", "11", "8"
    };
    
    static public String[] circumstanceIsOptions = {"Uncommon Circumstance","Common Circumstance","Very Common Circumstance"};
    
    static private Integer[] circumstanceIsCostArray = new Integer[] { new Integer(5), new Integer(10), new Integer(15) };
    
    static private Object[][] parameterArray = {
        {"CircumstanceIs","Disadvantage.CIRCUMSTANCEIS", String.class, "Common Circumstance", "Attack Is", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", circumstanceIsOptions},
        {"ActivationRoll","Disadvantage.LEVEL", String.class, "8", "Roll to Become", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", levels},
        {"RecoveryRoll","Disadvantage.RECOVERY", String.class, "14", "Roll to Recover", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", recoverylevels},
        {"Berserk","Disadvantage.BERSERK", Boolean.class, new Boolean(false), "Berserk", BOOLEAN_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
    };
    
    // Cost Array - See Power.getCostArray()
    static private Object[][] costArray = {
        { "CircumstanceIs", COMBO_COST, STATIC_RECONFIG, ZERO_RECONFIG, circumstanceIsCostArray, circumstanceIsOptions },
        { "ActivationRoll", COMBO_COST, STATIC_RECONFIG, ZERO_RECONFIG, levelsCostArray, levels },
        { "RecoveryRoll", COMBO_COST, STATIC_RECONFIG, ZERO_RECONFIG, levelsCostArray, recoverylevels },
        { "Berserk", BOOLEAN_COST, STATIC_RECONFIG, ZERO_RECONFIG, new Integer(10)},
    };
    
    // Power Definition Variables
    private static String powerName = "Enraged/Berserk"; // The Name of the Power
    ...
    private static Object[][] patterns = {
        { "CIRCUMSTANCES: (.*)", new Object[] {"CircumstanceIs", String.class}},
        { "CHANCETOGO: go ([0-9]*)-.*", new Object[] {"ActivationRoll", String.class}},
        { "CHANCETORECOVER: recover ([0-9]*)-.*", new Object[] {"RecoveryRoll", String.class}},
        { "(BERSERK).*", new Object[] {"Berserk", Boolean.class}},
        
    };
    
    /** Creates new powerHandToHandAttack */
    public disadvantageEnragedBerserk()  {
    }
    ...
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        String circumstance = (String)parameterList.getParameterValue("CircumstanceIs");
        ...
        if (circumstance.startsWith("Uncommon")) {
            parameterList.setParameterValue("CircumstanceIs", "Uncommon Circumstance");
        }
        if (circumstance.startsWith("Common")) {
            parameterList.setParameterValue("CircumstanceIs", "Common Circumstance");
        }
        if (circumstance.startsWith("Very Common")) {
            parameterList.setParameterValue("CircumstanceIs", "Very Common Circumstance");
        }
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && power.equals( "ENRAGED" )){
            return 10;
        }
        return 0;
    }
