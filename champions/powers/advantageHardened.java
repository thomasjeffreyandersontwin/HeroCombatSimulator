 ...
 */
public class advantageHardened extends AdvantageAdapter implements ChampionsConstants {
    ...
    public static String advantageName = "Hardened"; // The Name of the Advantage
    ...
    private static Object[][] patterns = {
        //MC 4e
     //   { "Hardened: �([0-9]*).*", new Object[] {"Levels", Integer.class}},
        //HD 
     //   { "Hardened \\(x([0-9]*);.*", new Object[] {"Levels", Integer.class}},
     //   { "Hardened.*", null }
        
    };
    
    public advantageHardened() {
    ...
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        ability.add("Ability.HARDENEDLEVELS", levels);
    ...
    public double calculateMultiplier() {
        ...
        return levels.doubleValue() * 0.25;
    }
...
/*    public int identifyAdvantage(AbilityImport ai, int line) {
        ...
        if ( possibleAdvantage != null && possibleAdvantage.indexOf("Hardened:") != -1) return 1;
        return 0;
    }
*/    
    public String getConfigSummary() {
        ...
        return "Hardened " + levels.toString();
    }
