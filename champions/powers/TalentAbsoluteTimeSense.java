 ...
 */
public class TalentAbsoluteTimeSense extends Talent 
implements ChampionsConstants {
    ...
    private static String powerName = "Absolute Time Sense"; // The Name of the Power
    ...
    public TalentAbsoluteTimeSense()  {
    }
