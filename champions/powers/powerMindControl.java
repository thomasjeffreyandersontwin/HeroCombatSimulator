 ...
 */
public class powerMindControl extends Power implements ChampionsConstants {
    ...
    static public String[] effectLevelOptions = {
        "Greater than STAT (Target Will Perform Actions He Is Inclined To Perform Anyway)",
        "STAT + 10 (Target Will Perform Actions He Wouldn't Mind Doing)",
        "STAT + 20 (Target Will Perform Actions He Is Normally Against Doing)",
        "STAT + 30 (Target Will Perform Actions He Is Violently Against Doing)"
    };
    
    static public String[] effectModifierOptions = {
        "-10 (Order Matches Target's Psychological Limitation)",
        "-5 (Order Is Worded In An Exceptionally Convincing Manner)",
        "+5 (Order Is Poorly Conceived Or Contradictory)",
        "+10 (Order Contradicts Target's Psychological Limitation)",
    ...
    private static Object[] customAdders = {
        Limitation.class, "Set Effect",
        Limitation.class, "Normal Range",
        Limitation.class, "Cannot Be Used Through Mind Link",
        Limitation.class, "Eye Contact Required",
        Limitation.class, "Skin Contact Required",
        Limitation.class, "Does Not Provide Mental Awareness",
        Limitation.class, "Mandatory Effect",
        Advantage.class, "Telepathic",
    };
...
//    }
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && ( power.equals( "MINDCONTROL" ) || power.equals( "Mind Control" ) )){
            return 10;
        }
        return 0;
    }
