 ...
 */
public class advantageTrigger extends AdvantageAdapter implements ChampionsConstants {
    ...
    static private Object[][] parameterArray = {
        {"Type","Ability.TRIGGERTYPE", String.class, "Set", "Trigger Type", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", new String[] { "Set", "Changable" }}
    };
    
    // Advantage Definition Variables
    public static String advantageName = "Trigger"; // The Name of the Advantage
   ...
   // Import Patterns Definitions
    private static Object[][] patterns = {
        { "Trigger: (.*),.*", new Object[] { "Type", String.class }}
    };
    
    /** Creates new advCombatModifier */
    public advantageTrigger() {
    }
    ...
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
       ...
       if ( type.equals( "SET" ) ) {
            parameterList.setParameterValue("Type", "Set");
            type = new String("Set");
        }
        else if ( type.equals( "VARIABLE" ) ) {
            parameterList.setParameterValue("Type", "Changable");
            type = new String("Changable");
        }        
        ...
        ability.add("Ability.ISTRIGGERED", "TRUE" , true , false);
        ability.add("Ability.REQUIRESNEWINSTANCE", "TRUE" , true , false);
        ability.add("Ability.ISINDEPENDENT", "TRUE" , true , false);
    ...
    public double calculateMultiplier() {
        ...
        return type.equals("Set") ? 0.25 : 0.5;
    }
