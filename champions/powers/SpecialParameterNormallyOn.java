 ...
 * @version
 */
public class SpecialParameterNormallyOn extends SpecialParameterAdapter implements ChampionsConstants {
    ...
    static private Object[][] parameterArray = {
        {"NormallyOn","Ability.NORMALLYON", Boolean.class, new Boolean(false), "Automatically Activate Each Phase", BOOLEAN_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
    };
    
    // SpecialParameter Definition Variables
    public static String specialParameterName = "Automatically Activate Ability"; // The Name of the SpecialParameter
    private static boolean unique = true; // Indicates whether multiple copies can be added to ability
    
    // Import Patterns Definitions
    private static Object[][] patterns = {
        // Special Parameter Normally On is imported directly by the AbilityImport class...
        // No patterns are necessary here...to change patterns look in AbilityImport.
    };

    public SpecialParameterNormallyOn() {
    ...
    public boolean configure(Ability ability, ParameterList parameterList) {
        ...
        boolean normallyOn = (Boolean)parameterList.getParameterValue("NormallyOn");
        ...
        //ability.add("Ability.NORMALLYON", normallyOn, true);
        ability.setNormallyOn( normallyOn );
    ...
    public void remove(Ability ability, int index) {
        //ability.remove("Ability.NORMALLYON");
    ...
    public String getConfigSummary(Ability ability, int index) {
        ...
        return normallyOn ? "Automatically Activate Each Phase" : "Don't Automatically Activate Each Phase";
    }
 ...
 */
    ...
    public int identifySpecialParameter(AbilityImport ai, int line) {
        ...
        if ( possibleSpecialParameter != null && possibleSpecialParameter.startsWith( "Automatically Activate:" )  ) {
            return 10;
        }
