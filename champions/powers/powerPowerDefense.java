 ...
 */
public class powerPowerDefense extends Power implements ChampionsConstants {
    static final long serialVersionUID = 4789274063056767496L;

    static private Object[][] parameterArray = {
    {"PowerDefense","Power.POWERDEFENSE", Integer.class, new Integer(5), "Power Defense", INTEGER_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
    };
    
    // Cost Array - See Power.getCostArray()
    static private Object[][] costArray = {
        { "PowerDefense", GEOMETRIC_COST, DYNAMIC_RECONFIG, PROPORTIONAL_RECONFIG, new Integer(1), new Integer(1), new Integer(0), new Integer(0) },
    };
    ...
    private static String powerName = "Power Defense"; // The Name of the Power
    ...
    private static Object[][] patterns = {
        { ".*\\(([0-9]*).*", new Object[] { "PowerDefense", Integer.class}}
    };
    
    /** Creates new powerHandToHandAttack */
    public powerPowerDefense()  {
    }
  ...
  */
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        Integer powerdefense = (Integer)parameterList.getParameterValue("PowerDefense");
        ...
        ability.add("Ability.POWERDEFENSE", powerdefense,true);
  ...
  /*  public int calculateCPCost(Ability ability) {
    ...
    public String getConfigSummary(Ability ability, int not_used) {
        ParameterList parameterList = getParameterList(ability);
        Integer pddefense = (Integer)parameterList.getParameterValue("PowerDefense");

        return pddefense.toString() + " Power Defense";
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && ( power.equals( "POWERLDEFENSE" ) || power.equals( "Power Defense" ) )){
            return 10;
        }
        return 0;
    }
    ...
    public boolean checkParameter(Ability ability, int not_used, String key, Object value, Object oldValue) {
        ...
        Integer pddefense = (Integer)parameterList.getParameterValue("PowerDefense", key, value);

        if ( pddefense.intValue() < 0 ) {
            return false;
        }
        return true;
    }
