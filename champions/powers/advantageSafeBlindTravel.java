 ...
 */
public class advantageSafeBlindTravel extends AdvantageAdapter implements ChampionsConstants {
  ...
  //  {"MaxShots","Ability.MAXSHOTS", Integer.class, new Integer(5), "Max Shots", INTEGER_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "MINIMUM", new Integer(2)}
    ...
    public static String advantageName = "Safe Blind Travel"; // The Name of the Advantage
   ...
   // Import Patterns Definitions
    ...
    public advantageSafeBlindTravel() {
    }
