 ...
 */
public class skillPower extends Skill implements ChampionsConstants {
    ...
    private static String powerName = "Power"; // The Name of the Power
    ...
    public void importPower(Ability ability, AbilityImport ai) {
        ...
        if (powername.equals("Acrobatics") || powername.equals("Breakfall") || powername.equals("Climbing") || powername.equals("Combat Driving") || powername.equals("Combat Piloting") || powername.equals("Contortionist") || powername.equals("Fast Draw") || powername.equals("Lockpicking") || powername.equals("Riding") || powername.equals("Sleight of Hand") || powername.equals("Stealth") || powername.equals("Teamwork")) {
            ...
            int index = ci.findIndexed("Stat", "NAME", "DEX");

            if (index != -1) {
                // Grab the EGO value and calculate the base MDF
                Integer dex = ci.getIndexedIntegerValue(index, "Stat", "VALUE");
                Integer level = new Integer(rollimport.intValue() - ChampionsUtilities.roundValue(dex.doubleValue() / 5.0, false) - 9);
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if (power != null && (power.equals("Acrobatics") || power.equals("Breakfall") || power.equals("Climbing") || power.equals("Combat Driving") || power.equals("Combat Piloting") || power.equals("Contortionist") || power.equals("Fast Draw") || power.equals("Lockpicking") || power.equals("Riding") || power.equals("Sleight of Hand") || power.equals("Stealth") || power.equals("Teamwork") || power.equals("Acting") || power.equals("Analyze") || power.equals("Animal Handler"))) {
            return 10;
        }
        return 0;
    }
