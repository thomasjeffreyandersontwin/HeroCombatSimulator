 ...
 */
public class limitationDoesntAffectFigured extends LimitationAdapter implements ChampionsConstants {
    ...
    public static String limitationName = "Doesn't Affect Figured"; // The Name of the Limitation
    ...
    public limitationDoesntAffectFigured() {
    }
