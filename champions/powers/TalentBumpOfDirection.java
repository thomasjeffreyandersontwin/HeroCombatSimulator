 ...
 */
public class TalentBumpOfDirection extends Talent 
implements ChampionsConstants {
    ...
    private static String powerName = "Bump Of Direction"; // The Name of the Power
