 ...
 */
public class disadvantageAccidentalChange extends Disadvantage implements ChampionsConstants {
    ...
    static private Integer[] levelsCostArray = new Integer[] { new Integer(0), new Integer(5), new Integer(10), new Integer(15) };
    
    static public String[] applyToOptions = {"STUN","BODY","Effect"};
    ...
    private static String powerName = "Accidental Change"; // The Name of the Power
    ...
    private static Object[][] patterns = {
        { "CHANCETOCHANGE: .*\\((.*)-.*", new Object[] {"ActivationRoll", String.class}},
        { "CHANCETOCHANGE: (Always)", new Object[] {"ActivationRoll", String.class}},
        { "CIRCUMSTANCES: (.*)", new Object[] {"CircumstanceIs", String.class}},
    };
    
    /** Creates new powerHandToHandAttack */
    public disadvantageAccidentalChange()  {
    }
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && power.equals( "ACCIDENTALCHANGE" )){
            return 10;
        }
        return 0;
    }
...
//    }
    ...
    public void triggerPower(BattleEvent be, Ability ability,DetailList effectList, Target target, int refNumber, String targetGroup) throws BattleEventException {
        Effect effect = new effectAccidentalChange( ability );
