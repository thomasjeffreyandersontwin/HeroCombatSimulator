 ...
 */
public class powerHandToHandAttack extends Power 
implements ChampionsConstants {
    ...
    {"Defense","Power.DEFENSE", String.class, "PD", "Defense", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", new String[] {"PD","ED"}}
    };
    
    
    // Power Definition Variables
    private static String powerName = "Hand-to-Hand Attack"; // The Name of the Power
  ...
  */
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        if ( Dice.isValid(die) == false ) return false; 
//        if ( !defense.equals("PD") && !defense.equals("ED") ) return false;
...
*/
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && ( power.equals( "HANDTOHANDATTACK" ) || power.equals( "Hand-To-Hand Attack" ) )){
            return 10;
        }
        return 0;
    }
