 ...
 */
public class skillLanguage extends Skill implements ChampionsConstants, BackgroundSkill {
    static final long serialVersionUID =5295828683348707403L;
    
    static public String[] levelOptions = {"basic conversation","fluent conversation","completely fluent","idiomatic","imitate dialects"};
    
//    static public String[] typeOptions = {"General","Culturial","Area","City"};
    
    static private Object[][] parameterArray = {
        {"Level","Power.LEVELS", String.class, "basic conversation", "Level", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", levelOptions},
//        {"Levels","Power.LEVEL", Integer.class, new Integer(0), "Extra Level", INTEGER_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
        {"Native","Power.NATIVE", Boolean.class, new Boolean(false), "Native Tongue", BOOLEAN_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
        {"Literate","Power.LITERATE", Boolean.class, new Boolean(false), "Literate", BOOLEAN_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
//        {"RollImport","Power.ROLLIMPORT", Integer.class, new Integer(0), "Roll Import", INTEGER_PARAMETER, HIDDEN, ENABLED, NOTREQUIRED},
//        {"Type","Power.Type", String.class, "General", "Type", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", typeOptions},
        {"Language","Power.LANGUAGE", String.class, "", "Language", STRING_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
        };
        ...
        private static String powerName = "Language"; // The Name of the Power
     ...
     */
        ...
        boolean literate = (Boolean)parameterList.getParameterValue("Literate");
        int cost = 1;
        
        if (level.equals("fluent conversation")) {
            cost = 2;
        }
        else if (level.equals("completely fluent")) {
            cost = 3;
        }
        else if (level.equals("idiomatic")) {
            cost = 4;
        }
        else if (level.equals("imitate dialects")) {
            cost = 5;
        }
        if (literate) {
            cost = cost + 1;
...
//        }
        ...
        public int getSkillRoll(Ability ability, Target target) {
            ...
            //String stat = (String)parameterList.getParameterValue("BaseStat");
            //Integer levels = (Integer)parameterList.getParameterValue("Levels");
            //String crammed = (String)parameterList.getParameterValue("Crammed");
            
            if ( target == null ) return Integer.MIN_VALUE;
            
            double statValue = target.getCurrentStat("INT");
            

                return ChampionsUtilities.roundValue(statValue/5 + 9 , true);
        }
...
//    }
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && power.equals( "LANGUAGES" )){
            return 10;
        }
        return 0;
    }
