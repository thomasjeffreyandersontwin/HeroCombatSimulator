 ...
 */
public class limitationBrightFringe extends LimitationAdapter implements ChampionsConstants {
    ...
    public static String limitationName = "Bright Fringe"; // The Name of the Limitation
