 ...
 */
public class skillProfessionalSkill extends Skill implements ChampionsConstants, BackgroundSkill {
    static final long serialVersionUID =5295828683348707403L;
    
    static public String[] statOptions = {"GENERAL", "STR","CON","DEX","BODY","INT","EGO","PRE","COM","PD",
    "ED","SPD","REC","END","STUN"};
    
    static private Object[][] parameterArray = {
        {"Profession","Power.PROFESSION", String.class, "", "Profession", STRING_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "FIELDWIDTH", 200},
    ...
    private static String powerName = "Professional Skill"; // The Name of the Power
    ...
    public String getConfigSummary(Ability ability, int not_used) {
        ...
        String profession = (String)parameterList.getParameterValue("Profession");
        Integer levels = (Integer)parameterList.getParameterValue("Levels");
        
        String s;
        
        if ( stat.equals("GENERAL") ) {
            s = "General professional skill in " + profession + ", " + levels.toString() + " level(s). (Skill Roll: " + (8 + levels) + ")";
        } else {
            s = stat + " professional skill in " + profession + ", " + levels.toString() + " level(s). (Skill Roll: " + stat + "/5 + " + (9+levels) + ")";
        }
        return s;
    }
