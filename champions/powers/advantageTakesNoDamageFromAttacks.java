 ...
 */
public class advantageTakesNoDamageFromAttacks extends AdvantageAdapter implements ChampionsConstants {
    static final long serialVersionUID = -6399128355211532419L;

        static private String[] typeOptions = { "Physical", "All Attacks" };
    ...
    static private Object[][] parameterArray = {
        {"Type","Advantage.TYPE", String.class, "Physical", "Damage Type", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", typeOptions},
    };
    

    
    // Advantage Definition Variables
    public static String advantageName = "Takes No Damage from Attacks"; // The Name of the Advantage
    ...
    public advantageTakesNoDamageFromAttacks() {
    }
    ...
    public String getConfigSummary() {       
        ...
        if ( type.equals("Physical" ) ) {
            return "Takes no damage from physical attacks";
        }
        else {
            return "Takes no damage from any attacks";
        }
    }
