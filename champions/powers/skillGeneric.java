 ...
 */
public class skillGeneric extends Skill implements ChampionsConstants {
    ...
    private static String powerName = "Generic Stat Based Skill"; // The Name of the Power
    ...
    public void importPower(Ability ability, AbilityImport ai) {
        ...
        if (powername.equals("Acrobatics") 

        ||  powername.equals( "Breakfall" )
        ||  powername.equals( "Climbing" )
    ...
    public int identifyPower(Ability template, AbilityImport ai) {
        ...
        if ( power != null && (power.equals( "Acrobatics" )
        ||  power.equals( "Breakfall" )
        ||  power.equals( "Climbing" )
        ||  power.equals( "Combat Driving" )
        ||  power.equals( "Combat Piloting" )
        ||  power.equals( "Contortionist" )
        ||  power.equals( "Fast Draw" )
        ||  power.equals( "Lockpicking" )
        ||  power.equals( "Riding" )
        ||  power.equals( "Sleight of Hand" )
        ||  power.equals( "Stealth" )
        ||  power.equals( "Teamwork" )
