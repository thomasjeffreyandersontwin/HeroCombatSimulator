...
public class SpecialParameterMultipowerSlot extends SpecialParameterAdapter implements ChampionsConstants {
    static final long serialVersionUID = -3750155454162254388L;
    
    static private String[] typeOptions = new String[] { "Flexible Slot", "Fixed Slot" };
    ...
    static private Object[][] parameterArray = {
        {"SlotType","SpecialParameter#.SLOTTYPE", String.class, "Flexible Slot", "Multipower Slot Type", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", typeOptions},
    };
    
    // SpecialParameter Definition Variables
    private static String specialParameterName = "Multipower Slot Type"; // The Name of the SpecialParameter
    ...
    public SpecialParameterMultipowerSlot() {
    ...
    public boolean configure(Ability ability, ParameterList parameterList) {
        ...
        String slotType = (String)parameterList.getParameterValue("SlotType");
        ...
        if ( slotType.equals("Flexible Slot") ) {
            ability.add("Multipower.FIXEDSLOT", "FALSE", true);
        }
        else {
            ability.add("Multipower.FIXEDSLOT", "TRUE", true);
        }
    ...
    public void remove(Ability ability, int index) {
        ability.remove("Multipower.FIXEDSLOT");
    }
