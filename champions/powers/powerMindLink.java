 ...
 */
public class powerMindLink extends Power implements ChampionsConstants {
    ...
    private static Object[][] patterns = {
        { ".* \\((Specific Group of Minds)\\).*", new Object[] { "RelatedGroup", Integer.class}},
        { "Number of Minds \\(x(.*)\\)", new Object[] { "MindMultiplier", Integer.class}},
        { "(Any distance)", new Object[] { "AnyDistance", Boolean.class}},
        { "(Any dimension)", new Object[] { "AnyDimension", Boolean.class}}
    };
    ...
    private static String powerName = "Mind Link"; // The Name of the Power
    ...
    private static String description = "Dude, its a Mind Link, ok?";
    
/** Creates new powerHandToHandAttack */
    public powerMindLink()  {
    }
