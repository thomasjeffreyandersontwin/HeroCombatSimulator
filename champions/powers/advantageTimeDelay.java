 ...
 */
public class advantageTimeDelay extends AdvantageAdapter implements ChampionsConstants {
  ...
  //  {"MaxShots","Ability.MAXSHOTS", Integer.class, new Integer(5), "Max Shots", INTEGER_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "MINIMUM", new Integer(2)}
    ...
    public static String advantageName = "Time Delay"; // The Name of the Advantage
