 ...
 */
public class limitationOthersOnly extends LimitationAdapter implements ChampionsConstants {
    ...
    public static String limitationName = "Others Only"; // The Name of the Limitation
    private static String limitationDescription = "Others Only"; // The Description of the Limitation
    ...
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
        ...
        if ( ability.hasLimitation( limitationSelfOnly.limitationName ) == true ) return false;
        ...
        if ( ability.isTargetSelf() == true ) {
            ability.setTargetSelf(false);
        }
        ability.setCannot("TARGETSELF", true);
    ...
    */
    ...
    public void removeLimitation() {
        //ability.remove("Ability.ATYPE");
        ability.clearAType();
        ability.remove("Ability.CANTARGETSELF");
    }
}