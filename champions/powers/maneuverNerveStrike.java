 ...
 */
public class maneuverNerveStrike extends Power implements ChampionsConstants {
    static final long serialVersionUID =5295846683348707403L;
    
    static private Object[][] parameterArray = {
        {"DamageDie","Power.DAMAGEDIE", String.class, "2d6", "Extra Damage Dice", DICE_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
        {"AttackType","NND.ATTACKTYPE", String.class, "", "Attack Type", STRING_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "FIELDWIDTH", 200},
        {"Defense","NND.DEFENSE", String.class, "Solid Armor Covering Pressure Points", "Defense", STRING_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "FIELDWIDTH", 200},
      //  {"OCVModifier","Ability.OCVBONUS", Integer.class, new Integer(-1), "Maneuver OCV Modifier", INTEGER_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
       // {"DCVModifier","Ability.DCVBONUS", Integer.class, new Integer(1), "Maneuver DCV Modifier", INTEGER_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
      //  {"MartialManeuver","Ability.ISMARTIALMANEUVER", String.class, "TRUE", "Martial Arts Skill", BOOLEAN_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
    };
    
    // Power Definition Variables
    private static String powerName = "Nerve Strike"; // The Name of the Power
  ...
  */
    public boolean configurePAD(Ability ability, ParameterList parameterList) {
     ...
     //   ability.addDiceInfo( "DamageDie", "", "Attack Damage");
        ...
        ability.setIs( "NND", true);
        ability.add( "Ability.DOESBODY", "FALSE", true);
        ability.add( "Ability.DOESKCOCKBACK", "FALSE", true);
        ability.add( "Ability.STRADDSTODC", "FALSE", true);
    ...
    public String getConfigSummary(Ability ability, int not_used) {
        ...
        if ( die.equals("0d6") == false ) {
            return attackType + " (+" + die + ")";
        }
        else {
            return attackType;
        }
    ...
    public void adjustDice(BattleEvent be, String targetGroup) {
        ...
        // This is kinda Kludgy.  Even though the bonus is 2d6 (normally), adjustDice adds 4 DC, since 
        // the PPDC is 10 and each maneuver DC is only 5 pts.
        be.add("Maneuver.DC", new Double( ChampionsUtilities.StringToNormalDC(die) * 2), true);
    } 
