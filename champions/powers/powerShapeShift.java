 ...
 */
public class powerShapeShift extends Power implements ChampionsConstants {
    ...
    // to what is selected....
    static private String[] shapesArray = {
        "Single Shape",
        "Up to Four Shapes",
        "Limited Group of Shapes",
        "Any Shape",
    };
    
    private static Object[][] parameterArray = {
        {"Shapes","Power.SHAPES", String.class, "Single Shape", "Number of Shapes", COMBO_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED, "OPTIONS", shapesArray },
        {"Senses","Sense*.SENSE", Sense.class, null, "Senses", LIST_PARAMETER, VISIBLE, ENABLED, REQUIRED},
//        {"Chameleon","Power.CHAMELEON", Boolean.class, new Boolean(false), "Chameleon", BOOLEAN_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
//        {"NotAttacking","Power.NOTATTACKING", Boolean.class, new Boolean(false), "Only When Not Attacking", BOOLEAN_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
        {"Cellular","Power.CELLULAR", Boolean.class, new Boolean(false), "Cellular", BOOLEAN_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
        {"Imitation","Power.IMITATION", Boolean.class, new Boolean(false), "Imitation", BOOLEAN_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
        {"InstantChange","Power.INSTANTCHANGE", Boolean.class, new Boolean(false), "Instant Change", BOOLEAN_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
        {"Makeover","Power.MAKEOVER", Boolean.class, new Boolean(false), "Makeover", BOOLEAN_PARAMETER, VISIBLE, ENABLED, NOTREQUIRED},
    };
...
//        { "Fringe", COMBO_COST, STATIC_RECONFIG, ZERO_RECONFIG, fringeCosts, fringeOptions },
    ...
    private static Object[] customAdders = {
       Limitation.class, "Affects Body Only",
        Limitation.class, "Limited Effect",
//        Limitation.class, "Bright Fringe",
    };
    
    
    // Power Definition Variables
    private static String powerName = "Invisibility"; // The Name of the Power
...
//        }
    ...
    public int calculateCPCost(Ability ability) {
        ...
        String shapes = (String)parameterList.getParameterValue("Shapes");
        boolean cellular = (Boolean)parameterList.getParameterValue("Cellular");
        boolean  imitation= (Boolean)parameterList.getParameterValue("Imitation");
        boolean instantchange = (Boolean)parameterList.getParameterValue("InstantChange");
        boolean makeover = (Boolean)parameterList.getParameterValue("Makeover");
        int cost = 0;
        boolean isFirstSenseGroupTargetting = false;
        
        if ( "Up to Four Shapes".equals(shapes) ) {
            cost += 5;
        } else if ( "Limited Group of Shapes".equals(shapes) ) {
            cost += 10;
        } else if ( "Any Shape".equals(shapes) ) {
            cost += 20;
        }
    ...
    public String getConfigSummary(Ability ability, int not_used) {
        ...
        StringBuffer sb = new StringBuffer("Invisibility");
//        if ( chameleon ) {
//            sb.append( "(Chameleon" );
//            hasParen = true;
//        }
