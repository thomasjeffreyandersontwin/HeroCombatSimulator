/*
 * limitationSkinContactRequired.java
 *
 ...
 * @author  1425
 */
public class limitationSkinContactRequiredAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "SKINCONTACTREQUIRED";
