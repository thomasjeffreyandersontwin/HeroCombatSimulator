 ...
 * @author  1425
 */
public class advantageCombatAccelerationAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "COMBATACCELERATION";
