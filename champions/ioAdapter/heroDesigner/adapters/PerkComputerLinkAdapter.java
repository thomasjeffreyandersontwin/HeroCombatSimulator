 ...
 * @author  1425
 */
public class PerkComputerLinkAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    
    private static String XMLID = "COMPUTER_LINK";
    private static String[][] translationArray = {
        { "BASECOST", "Levels", "levelsSpecial" },
