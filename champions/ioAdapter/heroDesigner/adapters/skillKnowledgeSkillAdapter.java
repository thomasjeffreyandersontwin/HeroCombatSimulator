 ...
 * @author  1425
 */
public class skillKnowledgeSkillAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    
    private static String XMLID = "KNOWLEDGE_SKILL"; // This is not right!!!
