 ...
 * @author  1425
 */
public class powerImagesAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    
    private static String XMLID = "IMAGES";
    private static String[][] translationArray = {
        ...
        { "ADDER(XMLID=DECREASEDPERROLL).LEVELS", "Level"},
        { "ADDER(XMLID=ALTERABLESIZE)", "AlterableSize", "trueSpecial" },
        //{ "MODIFIER(XMLID=ALTERABLESIZE)", "AlterableSize", "trueSpecial" },
        //{ "DECREASEDPERROLL", "Level" },
//        
