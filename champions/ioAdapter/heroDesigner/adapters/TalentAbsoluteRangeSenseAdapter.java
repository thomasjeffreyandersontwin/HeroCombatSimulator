 ...
 * @author  1425
 */
public class TalentAbsoluteRangeSenseAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    
    private static String XMLID = "ABSOLUTE_RANGE_SENSE";
