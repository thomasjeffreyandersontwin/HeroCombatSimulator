 ...
 * @author  1425
 */
public class maneuverBlockAdapter extends AbstractManeuverXMLAdapter implements ManeuverXMLAdapter {
    
    private static String[] displayArray = { "Martial Block",
    };
