 ...
 * @author  1425
 */
public class disadvantageRivalryAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    
    private static String XMLID = "RIVALRY";
    private static String[][] translationArray = {
        { "ADDER(XMLID=SITUATION).OPTION_ALIAS", "Situation"},
        { "ADDER(XMLID=POWER).OPTION_ALIAS", "RivalPower"},
        { "ADDER(XMLID=FIERCENESS).OPTION_ALIAS", "Fierceness"},
        { "ADDER(XMLID=KNOWLEDGE).OPTION_ALIAS", "Knowledge"},
        { "ADDER(XMLID=PC)", "RivalIsPC", "trueSpecial" },
    };
