 ...
 * @author  1425
 */
public class SpecialParameterENDSourceAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter {

    private static String XMLID = "ENDRESERVENAME";
