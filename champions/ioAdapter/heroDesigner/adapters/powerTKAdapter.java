 ...
 * @author  1425
 */
public class powerTKAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    
    private static String XMLID = "TELEKINESIS";
    private static String[][] translationArray = {
        { "LEVELS", "Strength" },
        { "ADDER(XMLID=FINEMANIPULATION)", "FineManipulation", "trueSpecial" },
