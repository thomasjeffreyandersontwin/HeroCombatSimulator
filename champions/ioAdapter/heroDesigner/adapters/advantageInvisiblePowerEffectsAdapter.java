/*
 * advantageInvisiblePowerEffects.java
 *
 ...
 * @author  1425
 */
public class advantageInvisiblePowerEffectsAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "INVISIBLE";
    private static String[][] translationArray = {
        { "OPTION_ALIAS", "SenseGroup" },
