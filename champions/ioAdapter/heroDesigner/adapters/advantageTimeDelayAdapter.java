 ...
 * @author  1425
 */
public class advantageTimeDelayAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "TIMEDELAY";
