 ...
 * @author  1425
 */
public class advantageNoRangePenaltyAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "NORANGEMODIFIER";
