/*
 * limitationReducedPenetration.java
 *
 ...
 * @author  1425
 */
public class limitationReducedPenetrationAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "REDUCEDPENETRATION";
