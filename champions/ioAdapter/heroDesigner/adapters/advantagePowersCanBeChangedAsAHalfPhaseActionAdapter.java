 ...
 * @author  1425
 */
public class advantagePowersCanBeChangedAsAHalfPhaseActionAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter {
    
    private static String XMLID = "HALFPHASE";
