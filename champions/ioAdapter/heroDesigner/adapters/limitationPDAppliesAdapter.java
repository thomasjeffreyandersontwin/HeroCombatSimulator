 ...
 * @author  1425
 */
public class limitationPDAppliesAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "PDAPPLIES";
