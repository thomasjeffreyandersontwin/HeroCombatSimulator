/*
 * limitationAlwaysOnAdapter.java
 *
 ...
 * @author  1425
 */
public class limitationAlwaysOnAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "ALWAYSON";
