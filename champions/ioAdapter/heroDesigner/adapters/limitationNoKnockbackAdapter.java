 ...
 * @author  1425
 */
public class limitationNoKnockbackAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "NOKB";
    private static String[][] translationArray = {
        { "MODIFIER(XMLID=NOKB)", "NoKnockback", "trueSpecial" }
