 ...
 * @author  1425
 */
public class advantageSafeBlindTravelAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "SAFEBLINDTRAVEL";
