 ...
 * @author  1425
 */
public class powerENDReserveAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    
    private static String XMLID = "ENDURANCERESERVE";
    private static String[][] translationArray = {
        { "LEVELS", "EndLevel" },
        { "POWER(XMLID=ENDURANCERESERVEREC).LEVELS", "RecLevel" }
    };
