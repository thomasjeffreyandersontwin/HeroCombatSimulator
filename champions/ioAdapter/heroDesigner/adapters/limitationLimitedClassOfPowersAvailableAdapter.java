 ...
 * @author  1425
 */
public class limitationLimitedClassOfPowersAvailableAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "LIMITED";
