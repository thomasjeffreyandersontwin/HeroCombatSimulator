 ...
 * @author  1425
 */
public class powerRunningAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    ...
    public powerRunningAdapter() {
        super();
    }
    
    public powerRunningAdapter(boolean basePower) {
        super();
