 ...
 * @author  1425
 */
public class skillGamblingAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    
    private static String XMLID = "GAMBLING";
    private static String[][] translationArray = {
        { "LEVELS", "Levels" },
        { "ADDER(XMLID=CARDGAMES)", "Categories", "setSpecial", "Card Games" },
//        { "ADDER(XMLID=MONEY)", "Categories", "setSpecial", "Money" },
//        { "ADDER(XMLID=ART)", "Categories", "setSpecial", "Art Objects" },
//        { "ADDER(XMLID=COMMERCIALGOODS)", "Categories", "setSpecial", "Commercial Goods" },
