 ...
 * @author  1425
 */
public class powerSwimmingAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    ...
    public powerSwimmingAdapter() {
        super();
    }
    
    public powerSwimmingAdapter(boolean basePower) {
        super();
