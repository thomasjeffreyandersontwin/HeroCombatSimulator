 ...
 * @author  1425
 */
public class advantageInherentAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "INHERENT";
