 ...
 * @author  1425
 */
public class maneuverKillingStrikeAdapter extends AbstractManeuverXMLAdapter implements ManeuverXMLAdapter {
    
    private static String[] displayArray = { "Killing Strike", 
                                            };
