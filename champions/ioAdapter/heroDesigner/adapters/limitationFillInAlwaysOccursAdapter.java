 ...
 * @author  1425
 */
public class limitationFillInAlwaysOccursAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "FILLINALWAYSOCCURS";
