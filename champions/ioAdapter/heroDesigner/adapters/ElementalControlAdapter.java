 ...
 * @author  1425
 */
public class ElementalControlAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    
    private static String XMLID = "ELEMENTAL_CONTROL";
    private static String[][] translationArray = {
        { "BASECOST", null, "poolsizeSpecial" },
    };
