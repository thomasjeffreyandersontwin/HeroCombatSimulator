 ...
 * @author  1425
 */
public class skillWeaponFamiliarityAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    
    private static String XMLID = "WEAPON_FAMILIARITY"; // This is not right!!!
