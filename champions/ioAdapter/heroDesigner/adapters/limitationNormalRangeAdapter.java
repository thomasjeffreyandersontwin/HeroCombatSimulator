 ...
 * @author  1425
 */
public class limitationNormalRangeAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "NORMALRANGE";
