 ...
 * @author  1425
 */
public class advantageNoSkillRollRequiredAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter {
    
    private static String XMLID = "NOSKILLROLL";
