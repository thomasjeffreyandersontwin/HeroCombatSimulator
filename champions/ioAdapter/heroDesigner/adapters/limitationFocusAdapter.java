 ...
 * @author  1425
 */
public class limitationFocusAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "FOCUS";
    private static String[][] translationArray = {
        { "COMMENTS", "Object" },
        { "OPTIONID", "Type" },
        { "ADDER(XMLID=BREAKABILITY).OPTIONID", "Fragile" },
        { "ADDER(XMLID=MOBILITY).OPTIONID", "Mobility" },
        { "ADDER(XMLID=BREAKABILITY).OPTIONID", "Breakability" },
        { "ADDER(XMLID=EXPENDABILITY).OPTIONID", "Expendable" },
    };
