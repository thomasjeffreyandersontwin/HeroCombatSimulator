 ...
 * @author  1425
 */
public class skillRapidAttackRangedAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    
    private static String XMLID = "RAPID_ATTACK_RANGED"; // This is not right!!!
