 ...
 * @author  1425
 */
public class advantageArmorPiercingAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "ARMORPIERCING";
