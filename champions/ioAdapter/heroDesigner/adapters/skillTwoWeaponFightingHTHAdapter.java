 ...
 * @author  1425
 */
public class skillTwoWeaponFightingHTHAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    
    private static String XMLID = "TWO_WEAPON_FIGHTING_HTH";
