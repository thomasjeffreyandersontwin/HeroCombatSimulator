 ...
 * @author  1425
 */
public class skillStandardCharBasedAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    
    private static String[] xmlidExcludes = {
        "BREAKFALL",
        "ACROBATICS",
        "ANIMAL_HANDLER",
        "CLIMBING",
    ...
    private static String XMLID = "POWERSKILL";
    ...
    public boolean identifyXML(String XMLID, Node node) {
        ...
        //String x = DefaultXMLHandler.findAttribute(node, "XMLID");
        
        for(String excludedXMLID : xmlidExcludes) {
            if ( excludedXMLID.equals(XMLID)) return false;
        }
