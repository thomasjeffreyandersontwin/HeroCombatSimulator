 ...
 * @author  1425
 */
public class maneuverDodgeAdapter extends AbstractManeuverXMLAdapter implements ManeuverXMLAdapter {
    
    private static String[] displayArray = { "Martial Dodge",
    };
