 ...
 * @author  1425
 */
public class powerDamageResistanceAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    
    private static String XMLID = "DAMAGERESISTANCE";
    private static String[][] translationArray = {
        { "PDLEVELS", "DamageResistancePD" },
        { "EDLEVELS", "DamageResistanceED" },
    };
