 ...
 * @author  1425
 */
public class powerForceWallAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    
    private static String XMLID = "FORCEWALL";
    private static String[][] translationArray = {
        { "PDLEVELS", "ForceWallPD" },
        { "EDLEVELS", "ForceWallED" },
        { "MDLEVELS", "ForceWallMD" },
        { "LENGTHLEVELS", "WidthLevel" },        
