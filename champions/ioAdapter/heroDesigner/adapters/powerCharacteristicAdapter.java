 ...
 * @author  1425
 */
public class powerCharacteristicAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    ...
    public boolean identifyXML(String XMLID, Node node) {
        if ( XMLID != null ) {
            ...
            for(int i = 0; i < powerCharacteristic.statOptions.length; i++) {
                if ( XMLID.equals(powerCharacteristic.statOptions[i])) {
                    return true;
                }
            }
        }
    ...
    public String getXMLID() {
        // This is never used, but must be here...
        return null;
    }
