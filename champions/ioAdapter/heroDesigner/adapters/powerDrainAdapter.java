 ...
 * @author  1425
 */
public class powerDrainAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    
    private static String XMLID = "DRAIN";
	...
	private boolean configureAdjusted(Target source, AbilityList abilities,ArrayList drainFromAbilities, String drainFromString) {
		SpecialEffect s;
		boolean found = false;
