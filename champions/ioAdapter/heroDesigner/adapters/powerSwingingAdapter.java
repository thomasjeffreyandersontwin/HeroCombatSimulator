 ...
 * @author  1425
 */
public class powerSwingingAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    
    private static String XMLID = "SWINGING";
    ...
    public powerSwingingAdapter() {
        super();
    }
    
    public powerSwingingAdapter(boolean basePower) {
        super();
