 ...
 * @author  1425
 */
public class limitationRestrainableAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "RESTRAINABLE";
    private static String[][] translationArray = {
        { "ADDER(XMLID=NOTVSGRABORENTANGLE)", "NotVSGrabOrEntangle", "trueSpecial"},
    };
