 ...
 * @author  1425
 */
public class powerMindControlAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    
    private static String XMLID = "MINDCONTROL";
    private static String[][] translationArray = {
        { "LEVELS", "DamageDie" },
        { "INPUT", "AdditionalClasses" },
        { "ADDER(XMLID=MULTIPLECLASSES).INPUT", "AdditionalClasses" },
    };
