 ...
 * @author  1425
 */
public class skillTwoWeaponFightingRangedAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    
    private static String XMLID = "TWO_WEAPON_FIGHTING_RANGED";
