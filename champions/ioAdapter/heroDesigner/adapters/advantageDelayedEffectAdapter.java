 ...
 */
public class advantageDelayedEffectAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "DELAYEDEFFECT";
