 ...
 * @author  1425
 */
public class limitationEDAppliesAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "EDAPPLIES";
