 ...
 * @author  1425
 */
public class advantageOrganizationContactAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "ORGANIZATION";
