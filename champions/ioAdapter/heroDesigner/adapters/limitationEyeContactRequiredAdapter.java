/*
 * limitationEyeContactRequired.java
 *
 ...
 * @author  1425
 */
public class limitationEyeContactRequiredAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "EYECONTACTREQUIRED";
