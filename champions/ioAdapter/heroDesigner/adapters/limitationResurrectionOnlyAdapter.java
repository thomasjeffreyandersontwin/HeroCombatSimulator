/*
 * limitationResurrectionOnly.java
 *
 ...
 * @author  1425
 */
public class limitationResurrectionOnlyAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "RESURRECTIONONLY";
