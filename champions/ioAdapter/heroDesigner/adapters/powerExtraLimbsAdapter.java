 ...
 * @author  1425
 */
public class powerExtraLimbsAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    
    private static String XMLID = "EXTRALIMBS";
    private static String[][] translationArray = {
        { "LEVELS", "NumberofLimbs" },
