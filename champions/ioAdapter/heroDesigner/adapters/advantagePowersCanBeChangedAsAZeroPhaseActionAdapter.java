 ...
 * @author  1425
 */
public class advantagePowersCanBeChangedAsAZeroPhaseActionAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter {
    
    private static String XMLID = "ZEROPHASE";
