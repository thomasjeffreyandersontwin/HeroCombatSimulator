/**
 * @file maneuverDisarmAdapter.java
 *
 ...
 * @author  pnoffke
 */
public class maneuverDisarmAdapter extends AbstractManeuverXMLAdapter implements ManeuverXMLAdapter {
    
    private static String[] displayArray = { "Martial Disarm" };
    ...
    public void dcSpecial(Ability ability, Node node, String attrValue, ParameterList pl, String parameterName, String specialData) {
        if (!attrValue.equals("0")) {
            pl.setParameterValue("Strength", Integer.parseInt(attrValue) * 5);
        }
    }
