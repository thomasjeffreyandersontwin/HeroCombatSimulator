 ...
 * @author  1425
 */
public class advantageHoleInTheMiddleAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "HOLEINTHEMIDDLE";
