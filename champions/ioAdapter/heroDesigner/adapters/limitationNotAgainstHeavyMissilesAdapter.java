 ...
 * @author  1425
 */
public class limitationNotAgainstHeavyMissilesAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "NOTAGAINSTHEAVY";
