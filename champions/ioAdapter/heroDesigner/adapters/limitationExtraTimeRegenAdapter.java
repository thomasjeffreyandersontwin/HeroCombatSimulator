 ...
 * @author  1425
 */
public class limitationExtraTimeRegenAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "REGENEXTRATIME";
    private static String[][] translationArray = {
        { "OPTION_ALIAS", "ExtraTimeLevel" },
