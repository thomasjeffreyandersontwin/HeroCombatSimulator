 ...
 * @author  1425
 */
public class advantageIncreasedStunMultiplierAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "INCREASEDSTUNMULTIPLIER";
    private static String[][] translationArray = {
        { "LEVELS", "StunMultiplier" },
