 ...
 * @author  1425
 */
public class limitationOnlyWhenNotAttackingAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "ONLYWHENNOTATTACKING";
