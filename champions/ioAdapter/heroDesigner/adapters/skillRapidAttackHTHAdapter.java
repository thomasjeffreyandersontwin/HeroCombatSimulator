 ...
 * @author  1425
 */
public class skillRapidAttackHTHAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    
    private static String XMLID = "RAPID_ATTACK_HTH"; // This is not right!!!
