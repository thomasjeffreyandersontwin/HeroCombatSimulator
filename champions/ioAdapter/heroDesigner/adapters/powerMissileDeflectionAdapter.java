 ...
 * @author  1425 
 */
public class powerMissileDeflectionAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    
    private static String XMLID = "MISSILEDEFLECTION";
    private static String[][] translationArray = {
        { "OPTION_ALIAS", "Type" },
        { "ADDER(XMLID=REFLECTION)", "Reflect", "setSpecial", "Reflect Attacks Back at Attacker" },
        { "ADDER(XMLID=ANYTARGET)", "Reflect", "setSpecial", "Reflect Attacks at Any Target"}
    };
