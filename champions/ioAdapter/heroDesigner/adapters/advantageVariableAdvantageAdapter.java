 ...
 * @author  1425
 */
public class advantageVariableAdvantageAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "VARIABLEADVANTAGE";
