 ...
 * @author  1425
 */
public class limitationCannotBeUsedThroughMindLinkAdapter extends AbstractModifierXMLAdapter implements ModifierXMLAdapter { 
    
    private static String XMLID = "NOTTHROUGHMINDLINK";
