 ...
 * @author  1425
 */
public class skillProfessionalSkillAdapter extends AbstractPowerXMLAdapter implements PowerXMLAdapter {
    
    private static String XMLID = "PROFESSIONAL_SKILL"; // This is not right!!!
