 ...
 * @version
 */
public class AdjAttackSourceStatsNode extends DefaultTreeTableNode implements ChampionsConstants {
    ...
    public AdjAttackSourceStatsNode(Ability sourceAbility, Target target, ArrayList adjustables) {
        ...
        if ( adjustables != null ) {
            ...
            for( index = 0; index < count; index++ ) {
                ...
                if ( adjustable instanceof Characteristic ) {
                        add( new AdjStatNode(((Characteristic)adjustable).getName()) );
                }
            }
        }
    }
