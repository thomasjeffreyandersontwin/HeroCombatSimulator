 ...
 * @version 
 */
public class TransferFromAttackTreeNode extends DefaultAttackTreeNode {
    ...
    public TransferFromAttackTreeNode(String name) {
        this.name = name;
    ...
    public boolean activateNode(boolean manualOverride) {
        ...
        AdjustmentList targetAL = (AdjustmentList)ai.getIndexedValue(tindex, "Target", "TRANSFERFROMLIST");
        ...
        setAdjustables( power.getAvailableFromAdjustables(battleEvent.getAbility(), target));
        ...
        if ( nodeRequiresInput() || manualOverride == true ) {
            ...
            attackTreePanel.setInstructions("Configure the Abilities/Stats of " + target.getName() + " to Transfer from...");
    ...
    public boolean processAdvance() {
        ...
        ai.addIndexed(tindex, "Target", "TRANSFERFROMLIST", adjustmentList, true);
