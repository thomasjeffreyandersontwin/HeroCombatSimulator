...
import champions.powers.effectHealTracker;
import champions.powers.powerHeal;
 ...
 * @version 
 */
public class HealToAttackTreeNode extends DefaultAttackTreeNode {
    ...
    public HealToAttackTreeNode(String name) {
        this.name = name;
    ...
    public boolean activateNode(boolean manualOverride) {
        ...
        AdjustmentList targetAL = (AdjustmentList)ai.getIndexedValue(tindex, "Target", "HEALTOLIST");
        
        if ( targetAL == null ) {
            effectHealTracker eat = powerHeal.findHealTracker(ai.getSource(), ai.getAbility());
            if ( eat == null ) {
        ...
        if ( nodeRequiresInput() || manualOverride == true ) {
            ...
            attackTreePanel.setInstructions("Configure the Abilities/Stats of " + target.getName() + " to Heal...");
    ...
    public boolean processAdvance() {
        ...
        ai.addIndexed(tindex, "Target", "HEALTOLIST", adjustmentList, true);
