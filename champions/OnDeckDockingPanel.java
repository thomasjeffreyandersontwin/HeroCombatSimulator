 ...
 * @author  unknown
 */
public class OnDeckDockingPanel extends SavedDockingPanel {
...
//    private BattleSequence battleEligible = new BattleSequence();
  ...
  //  private Action undoAction, redoAction, playAction, ffAction, showStatsAction, advanceSegmentAction, startBattleAction, purgeAction;
    ...
    public OnDeckDockingPanel() {
        this("onDeckDP");
    }
    
    public OnDeckDockingPanel(String windowID) {
        super(windowID);
        initComponents();
        setName("On-Deck Characters");
...
//    }
    ...
    private void initComponents() {
        ...
        onDeckList = new champions.OnDeckList();

        setName("Info");
        listGroup.setLayout(new java.awt.BorderLayout());

        onDeckList.setOpaque(false);
        listGroup.add(onDeckList, java.awt.BorderLayout.CENTER);
  ...
  private void addRosterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addRosterActionPerformed
    ...
    private champions.OnDeckList onDeckList;
