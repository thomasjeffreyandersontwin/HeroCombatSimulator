 ...
 * @version
 */
public class KnockbackModPanel extends JPanel {
    ...
    public KnockbackModPanel() {
        // Used only with subclasses
    }
    
    public KnockbackModPanel(String type, int index, String desc, Integer value, boolean active) {
        super();
        initComponents();
        setupIcons();
    ...
    public void updatePanel() {
        String s;
        if ( getValue() >= 0 && isBase() == false ) {
            s = "+" + Integer.toString( getValue() ) + "d6";
        }
        else {
            s = Integer.toString( getValue() ) + "d6";
        }
  ...
  private void valueTextFocusLost (java.awt.event.FocusEvent evt) {//GEN-FIRST:event_valueTextFocusLost
      ...
      try {
          ...
          Dice d = new Dice(valueString, false);
          setValue(d.getD6() * multiplier);
  ...
  public void setValue(int value) {
      if ( value != this.value ) {
          ...
          this.value = value;
          propertyChangeSupport.firePropertyChange( type + Integer.toString(index) + ".MODIFIER", oldvalue, value);
          updatePanel();
