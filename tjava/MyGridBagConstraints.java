/*
 * MYGribBagConstraints.java
 *
 * Created on January 25, 2001, 3:06 PM
 */
...
public class MyGridBagConstraints implements Cloneable, java.io.Serializable {
   ...
   /**
     ...
     * @see      java.awt.MyGridBagConstraints#gridwidth
     * @see      java.awt.MyGridBagConstraints#gridheight
     * @see      java.awt.MyGridBagConstraints#gridx
     * @see      java.awt.MyGridBagConstraints#gridy
     */
  ...
  public int gridheight;
   ...
   /**
     ...
     * @serial
     * @see #clone() 
     * @see java.awt.MyGridBagConstraints#weighty
     */
  public double weightx;
   ...
   /**
     ...
     * @serial
     * @see #clone()
     * @see java.awt.MyGridBagConstraints#weightx
     */
  ...
  public Insets insets;
   ...
   /**
     ...
     * @serial
     * @see #clone()
     * @see java.awt.MyGridBagConstraints#ipady
     */
  public int ipadx;
   ...
   /**
     ...
     * @serial
     * @see #clone()
     * @see java.awt.MyGridBagConstraints#ipadx
     */
  public int ipady;
  ...
  /**
    ...
    * @see java.awt.MyGridBagConstraints#weightx
    * @see java.awt.MyGridBagConstraints#weighty
    * @see java.awt.MyGridBagConstraints#anchor
    * @see java.awt.MyGridBagConstraints#fill
    * @see java.awt.MyGridBagConstraints#insets
    * @see java.awt.MyGridBagConstraints#ipadx
    * @see java.awt.MyGridBagConstraints#ipady
    * 
    * @since 1.2
    */
  public MyGridBagConstraints(int gridx, int gridy,
  ...
  public Object clone () {
      try { 
	  MyGridBagConstraints c = (MyGridBagConstraints)super.clone();
