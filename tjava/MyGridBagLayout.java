/*
 * MyGrigBagLayout.java
 *
 * Created on January 25, 2001, 2:02 PM
 */

package tjava;

/*
 * @(#)MyGridBagLayout.java	1.37 00/02/02
 *
 ...
 * <dt>{@link MyGridBagConstraints#gridwidth},
 * {@link MyGridBagConstraints#gridheight}
 * <dd>Specifies the number of cells in a row (for <code>gridwidth</code>)
 * or column (for <code>gridheight</code>)
 * in the component's display area.
 * The default value is 1.
 * Use <code>MyGridBagConstraints.REMAINDER</code> to specify
 * that the component be the last one in its row (for <code>gridwidth</code>)
 * or column (for <code>gridheight</code>).
 * Use <code>MyGridBagConstraints.RELATIVE</code> to specify
 * that the component be the next to last one
 * in its row (for <code>gridwidth</code>)
 * or column (for <code>gridheight</code>).
 * <dt>{@link MyGridBagConstraints#fill}
 * <dd>Used when the component's display area
 * is larger than the component's requested size
 * to determine whether (and how) to resize the component.
 * Possible values are
 * <code>MyGridBagConstraints.NONE</code> (the default),
 * <code>MyGridBagConstraints.HORIZONTAL</code>
 * (make the component wide enough to fill its display area
 * horizontally, but don't change its height),
 * <code>MyGridBagConstraints.VERTICAL</code>
 * (make the component tall enough to fill its display area
 * vertically, but don't change its width), and
 * <code>MyGridBagConstraints.BOTH</code>
 * (make the component fill its display area entirely).
 * <dt>{@link MyGridBagConstraints#ipadx},
 * {@link MyGridBagConstraints#ipady}
 ...
 * Valid values are
 * <code>MyGridBagConstraints.CENTER</code> (the default),
 * <code>MyGridBagConstraints.NORTH</code>,
 * <code>MyGridBagConstraints.NORTHEAST</code>,
 * <code>MyGridBagConstraints.EAST</code>,
 * <code>MyGridBagConstraints.SOUTHEAST</code>,
 * <code>MyGridBagConstraints.SOUTH</code>,
 * <code>MyGridBagConstraints.SOUTHWEST</code>,
 * <code>MyGridBagConstraints.WEST</code>, and
 * <code>MyGridBagConstraints.NORTHWEST</code>.
 * <dt>{@link MyGridBagConstraints#weightx},
 * {@link MyGridBagConstraints#weighty}
 ...
 * the <code>MyGridBagLayout</code> object puts any extra space
 ...
 * <p>
 * <img src="doc-files/MyGridBagLayout-1.gif"
 * ALIGN=center HSPACE=10 VSPACE=7>
 * <p>
 * Each of the ten components has the <code>fill</code> field
 * of its associated <code>MyGridBagConstraints</code> object
 * set to <code>MyGridBagConstraints.BOTH</code>.
 * In addition, the components have the following non-default constraints:
 * <p>
 * <ul>
 * <li>Button1, Button2, Button3: <code>weightx&nbsp;=&nbsp;1.0</code>
 * <li>Button4: <code>weightx&nbsp;=&nbsp;1.0</code>,
 * <code>gridwidth&nbsp;=&nbsp;MyGridBagConstraints.REMAINDER</code>
 * <li>Button5: <code>gridwidth&nbsp;=&nbsp;MyGridBagConstraints.REMAINDER</code>
 * <li>Button6: <code>gridwidth&nbsp;=&nbsp;MyGridBagConstraints.RELATIVE</code>
 * <li>Button7: <code>gridwidth&nbsp;=&nbsp;MyGridBagConstraints.REMAINDER</code>
 ...
 *
 *     	   c.gridwidth = MyGridBagConstraints.REMAINDER; //end row
 *         makebutton("Button4", gridbag, c);
 *
 *         c.weightx = 0.0;		   //reset to the default
 *         makebutton("Button5", gridbag, c); //another row
 *
 * 	   c.gridwidth = MyGridBagConstraints.RELATIVE; //next-to-last in row
 ...
 * @author Doug Stein
 * @see       java.awt.MyGridBagConstraints
 * @since     JDK1.0
 */
...
java.io.Serializable {
     ...
     * the actual <code>MyGridBagConstraints</code> object is returned.
    ...
    public Dimension preferredLayoutSize(Container parent) {
        MyGridBagLayoutInfo info = GetLayoutInfo(parent, PREFERREDSIZE);
    ...
    public Dimension minimumLayoutSize(Container parent) {
        MyGridBagLayoutInfo info = GetLayoutInfo(parent, MINSIZE);
        return GetMinSize(parent, info);
    }
     ...
     * order to satisfy the contraints of this <code>MyGridBagLayout</code>
     * object.
     * <p>
     * Most applications do not call this method directly.
    ...
    /* DEBUG
     *
     *  protected void DumpLayoutInfo(MyGridBagLayoutInfo s) {
     *    int x;
     *
    ...
    /* DEBUG
     *
     *  protected void DumpConstraints(MyGridBagConstraints constraints) {
     *    System.out.println(
     *		       "wt " +
     *		       constraints.weightx +
     *		       " " +
    ...
    protected MyGridBagLayoutInfo GetLayoutInfo(Container parent, int sizeflag) {
     ...
     */
    protected Dimension GetMinSize(Container parent, MyGridBagLayoutInfo info) {
